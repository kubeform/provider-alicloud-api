...
type FakeDomains struct {
	Fake *FakeVodV1alpha1
	ns   string
}

var domainsResource = schema.GroupVersionResource{Group: "vod.alicloud.kubeform.com", Version: "v1alpha1", Resource: "domains"}

var domainsKind = schema.GroupVersionKind{Group: "vod.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Domain"}
