...
type FakeSubscriptions struct {
	Fake *FakeDatahubV1alpha1
	ns   string
}

var subscriptionsResource = schema.GroupVersionResource{Group: "datahub.alicloud.kubeform.com", Version: "v1alpha1", Resource: "subscriptions"}

var subscriptionsKind = schema.GroupVersionKind{Group: "datahub.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Subscription"}
