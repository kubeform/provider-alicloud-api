...
func newContainerGroups(c *EciV1alpha1Client, namespace string) *containerGroups {
...
func (c *containerGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ContainerGroup, err error) {
...
func (c *containerGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ContainerGroupList, err error) {
...
func (c *containerGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *containerGroups) Create(ctx context.Context, containerGroup *v1alpha1.ContainerGroup, opts v1.CreateOptions) (result *v1alpha1.ContainerGroup, err error) {
	result = &v1alpha1.ContainerGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("containergroups").
...
func (c *containerGroups) Update(ctx context.Context, containerGroup *v1alpha1.ContainerGroup, opts v1.UpdateOptions) (result *v1alpha1.ContainerGroup, err error) {
	result = &v1alpha1.ContainerGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("containergroups").
...
func (c *containerGroups) UpdateStatus(ctx context.Context, containerGroup *v1alpha1.ContainerGroup, opts v1.UpdateOptions) (result *v1alpha1.ContainerGroup, err error) {
	result = &v1alpha1.ContainerGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("containergroups").
...
func (c *containerGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *containerGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *containerGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ContainerGroup, err error) {
	result = &v1alpha1.ContainerGroup{}
