...
type EciV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*EciV1alpha1Client, error) {
	...
	return &EciV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new EciV1alpha1Client for the given config and
...
func New(c rest.Interface) *EciV1alpha1Client {
	return &EciV1alpha1Client{c}
}
