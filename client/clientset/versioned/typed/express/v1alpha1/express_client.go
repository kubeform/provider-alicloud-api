...
func NewForConfig(c *rest.Config) (*ExpressV1alpha1Client, error) {
	...
	return &ExpressV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ExpressV1alpha1Client for the given config and
...
func New(c rest.Interface) *ExpressV1alpha1Client {
	return &ExpressV1alpha1Client{c}
}
