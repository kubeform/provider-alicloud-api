...
import (
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/clientset/versioned/typed/rds/v1alpha1"
...
func (c *FakeRdsV1alpha1) Accounts(namespace string) v1alpha1.AccountInterface {
