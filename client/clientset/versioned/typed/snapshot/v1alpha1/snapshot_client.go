...
// SnapshotV1alpha1Client is used to interact with features provided by the snapshot.alicloud.kubeform.com group.
type SnapshotV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SnapshotV1alpha1Client) Policies(namespace string) PolicyInterface {
