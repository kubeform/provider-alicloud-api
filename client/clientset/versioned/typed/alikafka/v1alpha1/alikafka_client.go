...
type AlikafkaV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*AlikafkaV1alpha1Client, error) {
	...
	return &AlikafkaV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AlikafkaV1alpha1Client for the given config and
...
func New(c rest.Interface) *AlikafkaV1alpha1Client {
	return &AlikafkaV1alpha1Client{c}
}
