...
var rulesResource = schema.GroupVersionResource{Group: "config.alicloud.kubeform.com", Version: "v1alpha1", Resource: "rules"}

var rulesKind = schema.GroupVersionKind{Group: "config.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Rule"}
