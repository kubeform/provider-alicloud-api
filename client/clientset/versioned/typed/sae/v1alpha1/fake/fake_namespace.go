...
var namespacesResource = schema.GroupVersionResource{Group: "sae.alicloud.kubeform.com", Version: "v1alpha1", Resource: "namespaces"}

var namespacesKind = schema.GroupVersionKind{Group: "sae.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Namespace"}
...
func (c *FakeNamespaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Namespace, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(namespacesResource, c.ns, name, pt, data, subresources...), &v1alpha1.Namespace{})
