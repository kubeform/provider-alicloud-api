...
type RosV1alpha1Interface interface {
...
func (c *RosV1alpha1Client) ChangeSets(namespace string) ChangeSetInterface {
	return newChangeSets(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*RosV1alpha1Client, error) {
	...
	return &RosV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new RosV1alpha1Client for the given config and
...
func New(c rest.Interface) *RosV1alpha1Client {
	return &RosV1alpha1Client{c}
}
