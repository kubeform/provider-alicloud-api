...
var stacksResource = schema.GroupVersionResource{Group: "ros.alicloud.kubeform.com", Version: "v1alpha1", Resource: "stacks"}

var stacksKind = schema.GroupVersionKind{Group: "ros.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Stack"}
...
func (c *FakeStacks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Stack, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(stacksResource, c.ns, name, pt, data, subresources...), &v1alpha1.Stack{})
