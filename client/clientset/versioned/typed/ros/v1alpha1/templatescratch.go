...
// TemplateScratchesGetter has a method to return a TemplateScratchInterface.
...
// templateScratches implements TemplateScratchInterface
type templateScratches struct {
	client rest.Interface
	ns     string
}

// newTemplateScratches returns a TemplateScratches
func newTemplateScratches(c *RosV1alpha1Client, namespace string) *templateScratches {
...
func (c *templateScratches) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TemplateScratch, err error) {
	result = &v1alpha1.TemplateScratch{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *templateScratches) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TemplateScratchList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TemplateScratchList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("templatescratches").
...
func (c *templateScratches) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *templateScratches) Create(ctx context.Context, templateScratch *v1alpha1.TemplateScratch, opts v1.CreateOptions) (result *v1alpha1.TemplateScratch, err error) {
	result = &v1alpha1.TemplateScratch{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("templatescratches").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(templateScratch).
		Do(ctx).
		Into(result)
	return
}
...
func (c *templateScratches) Update(ctx context.Context, templateScratch *v1alpha1.TemplateScratch, opts v1.UpdateOptions) (result *v1alpha1.TemplateScratch, err error) {
	result = &v1alpha1.TemplateScratch{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("templatescratches").
		Name(templateScratch.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(templateScratch).
		Do(ctx).
		Into(result)
...
func (c *templateScratches) UpdateStatus(ctx context.Context, templateScratch *v1alpha1.TemplateScratch, opts v1.UpdateOptions) (result *v1alpha1.TemplateScratch, err error) {
	result = &v1alpha1.TemplateScratch{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("templatescratches").
...
func (c *templateScratches) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *templateScratches) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *templateScratches) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TemplateScratch, err error) {
	result = &v1alpha1.TemplateScratch{}
