...
func newStacks(c *RosV1alpha1Client, namespace string) *stacks {
	return &stacks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *stacks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Stack, err error) {
...
func (c *stacks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StackList, err error) {
...
func (c *stacks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *stacks) Create(ctx context.Context, stack *v1alpha1.Stack, opts v1.CreateOptions) (result *v1alpha1.Stack, err error) {
	result = &v1alpha1.Stack{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("stacks").
...
func (c *stacks) Update(ctx context.Context, stack *v1alpha1.Stack, opts v1.UpdateOptions) (result *v1alpha1.Stack, err error) {
	result = &v1alpha1.Stack{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("stacks").
...
func (c *stacks) UpdateStatus(ctx context.Context, stack *v1alpha1.Stack, opts v1.UpdateOptions) (result *v1alpha1.Stack, err error) {
	result = &v1alpha1.Stack{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("stacks").
...
func (c *stacks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *stacks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *stacks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Stack, err error) {
	result = &v1alpha1.Stack{}
