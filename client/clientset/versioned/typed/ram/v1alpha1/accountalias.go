...
// AccountAliasesGetter has a method to return a AccountAliasInterface.
...
// accountAliases implements AccountAliasInterface
type accountAliases struct {
	client rest.Interface
	ns     string
}

// newAccountAliases returns a AccountAliases
func newAccountAliases(c *RamV1alpha1Client, namespace string) *accountAliases {
...
func (c *accountAliases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AccountAlias, err error) {
	result = &v1alpha1.AccountAlias{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("accountaliases").
		Name(name).
...
func (c *accountAliases) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AccountAliasList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AccountAliasList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("accountaliases").
...
func (c *accountAliases) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *accountAliases) Create(ctx context.Context, accountAlias *v1alpha1.AccountAlias, opts v1.CreateOptions) (result *v1alpha1.AccountAlias, err error) {
	result = &v1alpha1.AccountAlias{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("accountaliases").
...
func (c *accountAliases) Update(ctx context.Context, accountAlias *v1alpha1.AccountAlias, opts v1.UpdateOptions) (result *v1alpha1.AccountAlias, err error) {
	result = &v1alpha1.AccountAlias{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountaliases").
...
func (c *accountAliases) UpdateStatus(ctx context.Context, accountAlias *v1alpha1.AccountAlias, opts v1.UpdateOptions) (result *v1alpha1.AccountAlias, err error) {
	result = &v1alpha1.AccountAlias{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountaliases").
...
func (c *accountAliases) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *accountAliases) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *accountAliases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AccountAlias, err error) {
	result = &v1alpha1.AccountAlias{}
