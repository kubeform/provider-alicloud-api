...
func newSamlProviders(c *RamV1alpha1Client, namespace string) *samlProviders {
...
func (c *samlProviders) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SamlProvider, err error) {
	result = &v1alpha1.SamlProvider{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *samlProviders) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SamlProviderList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SamlProviderList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("samlproviders").
...
func (c *samlProviders) Create(ctx context.Context, samlProvider *v1alpha1.SamlProvider, opts v1.CreateOptions) (result *v1alpha1.SamlProvider, err error) {
	result = &v1alpha1.SamlProvider{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("samlproviders").
...
func (c *samlProviders) Update(ctx context.Context, samlProvider *v1alpha1.SamlProvider, opts v1.UpdateOptions) (result *v1alpha1.SamlProvider, err error) {
	result = &v1alpha1.SamlProvider{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("samlproviders").
...
func (c *samlProviders) UpdateStatus(ctx context.Context, samlProvider *v1alpha1.SamlProvider, opts v1.UpdateOptions) (result *v1alpha1.SamlProvider, err error) {
	result = &v1alpha1.SamlProvider{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("samlproviders").
...
func (c *samlProviders) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SamlProvider, err error) {
	result = &v1alpha1.SamlProvider{}
