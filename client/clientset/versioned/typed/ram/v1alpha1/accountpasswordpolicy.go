...
// AccountPasswordPoliciesGetter has a method to return a AccountPasswordPolicyInterface.
...
// accountPasswordPolicies implements AccountPasswordPolicyInterface
type accountPasswordPolicies struct {
	client rest.Interface
	ns     string
}

// newAccountPasswordPolicies returns a AccountPasswordPolicies
func newAccountPasswordPolicies(c *RamV1alpha1Client, namespace string) *accountPasswordPolicies {
	return &accountPasswordPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *accountPasswordPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AccountPasswordPolicy, err error) {
	result = &v1alpha1.AccountPasswordPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *accountPasswordPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AccountPasswordPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AccountPasswordPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("accountpasswordpolicies").
...
func (c *accountPasswordPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *accountPasswordPolicies) Create(ctx context.Context, accountPasswordPolicy *v1alpha1.AccountPasswordPolicy, opts v1.CreateOptions) (result *v1alpha1.AccountPasswordPolicy, err error) {
	result = &v1alpha1.AccountPasswordPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("accountpasswordpolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(accountPasswordPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *accountPasswordPolicies) Update(ctx context.Context, accountPasswordPolicy *v1alpha1.AccountPasswordPolicy, opts v1.UpdateOptions) (result *v1alpha1.AccountPasswordPolicy, err error) {
	result = &v1alpha1.AccountPasswordPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountpasswordpolicies").
		Name(accountPasswordPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(accountPasswordPolicy).
		Do(ctx).
		Into(result)
...
func (c *accountPasswordPolicies) UpdateStatus(ctx context.Context, accountPasswordPolicy *v1alpha1.AccountPasswordPolicy, opts v1.UpdateOptions) (result *v1alpha1.AccountPasswordPolicy, err error) {
	result = &v1alpha1.AccountPasswordPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountpasswordpolicies").
...
func (c *accountPasswordPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *accountPasswordPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *accountPasswordPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AccountPasswordPolicy, err error) {
	result = &v1alpha1.AccountPasswordPolicy{}
