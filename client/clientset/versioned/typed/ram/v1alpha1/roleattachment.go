...
// RoleAttachmentsGetter has a method to return a RoleAttachmentInterface.
...
// roleAttachments implements RoleAttachmentInterface
type roleAttachments struct {
	client rest.Interface
	ns     string
}

// newRoleAttachments returns a RoleAttachments
func newRoleAttachments(c *RamV1alpha1Client, namespace string) *roleAttachments {
...
func (c *roleAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RoleAttachment, err error) {
	result = &v1alpha1.RoleAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *roleAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RoleAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RoleAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("roleattachments").
...
func (c *roleAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *roleAttachments) Create(ctx context.Context, roleAttachment *v1alpha1.RoleAttachment, opts v1.CreateOptions) (result *v1alpha1.RoleAttachment, err error) {
	result = &v1alpha1.RoleAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("roleattachments").
...
func (c *roleAttachments) Update(ctx context.Context, roleAttachment *v1alpha1.RoleAttachment, opts v1.UpdateOptions) (result *v1alpha1.RoleAttachment, err error) {
	result = &v1alpha1.RoleAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("roleattachments").
		Name(roleAttachment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(roleAttachment).
		Do(ctx).
		Into(result)
...
func (c *roleAttachments) UpdateStatus(ctx context.Context, roleAttachment *v1alpha1.RoleAttachment, opts v1.UpdateOptions) (result *v1alpha1.RoleAttachment, err error) {
	result = &v1alpha1.RoleAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("roleattachments").
...
func (c *roleAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *roleAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *roleAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RoleAttachment, err error) {
	result = &v1alpha1.RoleAttachment{}
