...
type RamV1alpha1Interface interface {
...
func (c *RamV1alpha1Client) LoginProfiles(namespace string) LoginProfileInterface {
	return newLoginProfiles(c, namespace)
}
...
func (c *RamV1alpha1Client) RoleAttachments(namespace string) RoleAttachmentInterface {
	return newRoleAttachments(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*RamV1alpha1Client, error) {
	...
	return &RamV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new RamV1alpha1Client for the given config and
...
func New(c rest.Interface) *RamV1alpha1Client {
	return &RamV1alpha1Client{c}
}
