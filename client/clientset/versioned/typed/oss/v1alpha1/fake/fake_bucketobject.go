...
type FakeBucketObjects struct {
	Fake *FakeOssV1alpha1
	ns   string
}

var bucketobjectsResource = schema.GroupVersionResource{Group: "oss.alicloud.kubeform.com", Version: "v1alpha1", Resource: "bucketobjects"}

var bucketobjectsKind = schema.GroupVersionKind{Group: "oss.alicloud.kubeform.com", Version: "v1alpha1", Kind: "BucketObject"}
