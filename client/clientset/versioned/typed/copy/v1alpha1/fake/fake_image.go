...
type FakeImages struct {
	Fake *FakeCopyV1alpha1
	ns   string
}

var imagesResource = schema.GroupVersionResource{Group: "copy.alicloud.kubeform.com", Version: "v1alpha1", Resource: "images"}

var imagesKind = schema.GroupVersionKind{Group: "copy.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Image"}
