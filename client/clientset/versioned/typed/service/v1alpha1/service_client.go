...
type ServiceV1alpha1Interface interface {
	...
	MeshServiceMeshesGetter
}

// ServiceV1alpha1Client is used to interact with features provided by the service.alicloud.kubeform.com group.
type ServiceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ServiceV1alpha1Client) MeshServiceMeshes(namespace string) MeshServiceMeshInterface {
	return newMeshServiceMeshes(c, namespace)
}
