...
type FakeOrders struct {
	Fake *FakeMarketV1alpha1
	ns   string
}

var ordersResource = schema.GroupVersionResource{Group: "market.alicloud.kubeform.com", Version: "v1alpha1", Resource: "orders"}

var ordersKind = schema.GroupVersionKind{Group: "market.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Order"}
