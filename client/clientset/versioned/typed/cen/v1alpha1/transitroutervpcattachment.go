...
// TransitRouterVpcAttachmentsGetter has a method to return a TransitRouterVpcAttachmentInterface.
...
// transitRouterVpcAttachments implements TransitRouterVpcAttachmentInterface
type transitRouterVpcAttachments struct {
	client rest.Interface
	ns     string
}

// newTransitRouterVpcAttachments returns a TransitRouterVpcAttachments
func newTransitRouterVpcAttachments(c *CenV1alpha1Client, namespace string) *transitRouterVpcAttachments {
	return &transitRouterVpcAttachments{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *transitRouterVpcAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TransitRouterVpcAttachment, err error) {
	result = &v1alpha1.TransitRouterVpcAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *transitRouterVpcAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TransitRouterVpcAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TransitRouterVpcAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("transitroutervpcattachments").
...
func (c *transitRouterVpcAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *transitRouterVpcAttachments) Create(ctx context.Context, transitRouterVpcAttachment *v1alpha1.TransitRouterVpcAttachment, opts v1.CreateOptions) (result *v1alpha1.TransitRouterVpcAttachment, err error) {
	result = &v1alpha1.TransitRouterVpcAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("transitroutervpcattachments").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(transitRouterVpcAttachment).
		Do(ctx).
		Into(result)
	return
}
...
func (c *transitRouterVpcAttachments) Update(ctx context.Context, transitRouterVpcAttachment *v1alpha1.TransitRouterVpcAttachment, opts v1.UpdateOptions) (result *v1alpha1.TransitRouterVpcAttachment, err error) {
	result = &v1alpha1.TransitRouterVpcAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("transitroutervpcattachments").
		Name(transitRouterVpcAttachment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(transitRouterVpcAttachment).
		Do(ctx).
		Into(result)
...
func (c *transitRouterVpcAttachments) UpdateStatus(ctx context.Context, transitRouterVpcAttachment *v1alpha1.TransitRouterVpcAttachment, opts v1.UpdateOptions) (result *v1alpha1.TransitRouterVpcAttachment, err error) {
	result = &v1alpha1.TransitRouterVpcAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("transitroutervpcattachments").
...
func (c *transitRouterVpcAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *transitRouterVpcAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *transitRouterVpcAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TransitRouterVpcAttachment, err error) {
	result = &v1alpha1.TransitRouterVpcAttachment{}
