...
type FakeInstances struct {
	Fake *FakeEcpV1alpha1
	ns   string
}

var instancesResource = schema.GroupVersionResource{Group: "ecp.alicloud.kubeform.com", Version: "v1alpha1", Resource: "instances"}

var instancesKind = schema.GroupVersionKind{Group: "ecp.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Instance"}
