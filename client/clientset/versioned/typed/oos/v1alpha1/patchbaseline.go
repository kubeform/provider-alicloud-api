...
// PatchBaselinesGetter has a method to return a PatchBaselineInterface.
...
// patchBaselines implements PatchBaselineInterface
type patchBaselines struct {
	client rest.Interface
	ns     string
}

// newPatchBaselines returns a PatchBaselines
func newPatchBaselines(c *OosV1alpha1Client, namespace string) *patchBaselines {
...
func (c *patchBaselines) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PatchBaseline, err error) {
	result = &v1alpha1.PatchBaseline{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *patchBaselines) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PatchBaselineList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PatchBaselineList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("patchbaselines").
...
func (c *patchBaselines) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *patchBaselines) Create(ctx context.Context, patchBaseline *v1alpha1.PatchBaseline, opts v1.CreateOptions) (result *v1alpha1.PatchBaseline, err error) {
	result = &v1alpha1.PatchBaseline{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("patchbaselines").
...
func (c *patchBaselines) Update(ctx context.Context, patchBaseline *v1alpha1.PatchBaseline, opts v1.UpdateOptions) (result *v1alpha1.PatchBaseline, err error) {
	result = &v1alpha1.PatchBaseline{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("patchbaselines").
		Name(patchBaseline.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(patchBaseline).
		Do(ctx).
		Into(result)
...
func (c *patchBaselines) UpdateStatus(ctx context.Context, patchBaseline *v1alpha1.PatchBaseline, opts v1.UpdateOptions) (result *v1alpha1.PatchBaseline, err error) {
	result = &v1alpha1.PatchBaseline{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("patchbaselines").
...
func (c *patchBaselines) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *patchBaselines) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *patchBaselines) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PatchBaseline, err error) {
	result = &v1alpha1.PatchBaseline{}
