...
func newFlowLogs(c *VpcV1alpha1Client, namespace string) *flowLogs {
	return &flowLogs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *flowLogs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FlowLog, err error) {
...
func (c *flowLogs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FlowLogList, err error) {
...
func (c *flowLogs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *flowLogs) Create(ctx context.Context, flowLog *v1alpha1.FlowLog, opts v1.CreateOptions) (result *v1alpha1.FlowLog, err error) {
	result = &v1alpha1.FlowLog{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("flowlogs").
...
func (c *flowLogs) Update(ctx context.Context, flowLog *v1alpha1.FlowLog, opts v1.UpdateOptions) (result *v1alpha1.FlowLog, err error) {
	result = &v1alpha1.FlowLog{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("flowlogs").
...
func (c *flowLogs) UpdateStatus(ctx context.Context, flowLog *v1alpha1.FlowLog, opts v1.UpdateOptions) (result *v1alpha1.FlowLog, err error) {
	result = &v1alpha1.FlowLog{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("flowlogs").
...
func (c *flowLogs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *flowLogs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *flowLogs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FlowLog, err error) {
	result = &v1alpha1.FlowLog{}
