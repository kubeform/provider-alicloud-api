...
func newBgpPeers(c *VpcV1alpha1Client, namespace string) *bgpPeers {
	return &bgpPeers{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *bgpPeers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BgpPeer, err error) {
...
func (c *bgpPeers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BgpPeerList, err error) {
...
func (c *bgpPeers) Create(ctx context.Context, bgpPeer *v1alpha1.BgpPeer, opts v1.CreateOptions) (result *v1alpha1.BgpPeer, err error) {
	result = &v1alpha1.BgpPeer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bgppeers").
...
func (c *bgpPeers) Update(ctx context.Context, bgpPeer *v1alpha1.BgpPeer, opts v1.UpdateOptions) (result *v1alpha1.BgpPeer, err error) {
	result = &v1alpha1.BgpPeer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bgppeers").
...
func (c *bgpPeers) UpdateStatus(ctx context.Context, bgpPeer *v1alpha1.BgpPeer, opts v1.UpdateOptions) (result *v1alpha1.BgpPeer, err error) {
	result = &v1alpha1.BgpPeer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bgppeers").
...
func (c *bgpPeers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BgpPeer, err error) {
	result = &v1alpha1.BgpPeer{}
