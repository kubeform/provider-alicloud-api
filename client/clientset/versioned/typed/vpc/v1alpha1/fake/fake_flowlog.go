...
var flowlogsResource = schema.GroupVersionResource{Group: "vpc.alicloud.kubeform.com", Version: "v1alpha1", Resource: "flowlogs"}

var flowlogsKind = schema.GroupVersionKind{Group: "vpc.alicloud.kubeform.com", Version: "v1alpha1", Kind: "FlowLog"}
...
func (c *FakeFlowLogs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FlowLogList, err error) {
	...
	list := &v1alpha1.FlowLogList{ListMeta: obj.(*v1alpha1.FlowLogList).ListMeta}
	for _, item := range obj.(*v1alpha1.FlowLogList).Items {
