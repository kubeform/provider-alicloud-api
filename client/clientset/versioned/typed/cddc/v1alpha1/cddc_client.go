...
func NewForConfig(c *rest.Config) (*CddcV1alpha1Client, error) {
	...
	return &CddcV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CddcV1alpha1Client for the given config and
...
func New(c rest.Interface) *CddcV1alpha1Client {
	return &CddcV1alpha1Client{c}
}
