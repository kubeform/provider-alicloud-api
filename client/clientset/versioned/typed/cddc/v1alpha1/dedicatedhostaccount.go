...
// DedicatedHostAccountsGetter has a method to return a DedicatedHostAccountInterface.
...
// dedicatedHostAccounts implements DedicatedHostAccountInterface
type dedicatedHostAccounts struct {
	client rest.Interface
	ns     string
}

// newDedicatedHostAccounts returns a DedicatedHostAccounts
func newDedicatedHostAccounts(c *CddcV1alpha1Client, namespace string) *dedicatedHostAccounts {
	return &dedicatedHostAccounts{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *dedicatedHostAccounts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DedicatedHostAccount, err error) {
	result = &v1alpha1.DedicatedHostAccount{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dedicatedHostAccounts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DedicatedHostAccountList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DedicatedHostAccountList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dedicatedhostaccounts").
...
func (c *dedicatedHostAccounts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dedicatedHostAccounts) Create(ctx context.Context, dedicatedHostAccount *v1alpha1.DedicatedHostAccount, opts v1.CreateOptions) (result *v1alpha1.DedicatedHostAccount, err error) {
	result = &v1alpha1.DedicatedHostAccount{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dedicatedhostaccounts").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dedicatedHostAccount).
		Do(ctx).
		Into(result)
	return
}
...
func (c *dedicatedHostAccounts) Update(ctx context.Context, dedicatedHostAccount *v1alpha1.DedicatedHostAccount, opts v1.UpdateOptions) (result *v1alpha1.DedicatedHostAccount, err error) {
	result = &v1alpha1.DedicatedHostAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dedicatedhostaccounts").
		Name(dedicatedHostAccount.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dedicatedHostAccount).
		Do(ctx).
		Into(result)
...
func (c *dedicatedHostAccounts) UpdateStatus(ctx context.Context, dedicatedHostAccount *v1alpha1.DedicatedHostAccount, opts v1.UpdateOptions) (result *v1alpha1.DedicatedHostAccount, err error) {
	result = &v1alpha1.DedicatedHostAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dedicatedhostaccounts").
...
func (c *dedicatedHostAccounts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dedicatedHostAccounts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dedicatedHostAccounts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DedicatedHostAccount, err error) {
	result = &v1alpha1.DedicatedHostAccount{}
