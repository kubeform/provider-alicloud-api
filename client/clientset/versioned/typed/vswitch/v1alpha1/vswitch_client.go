...
// VswitchV1alpha1Client is used to interact with features provided by the vswitch.alicloud.kubeform.com group.
type VswitchV1alpha1Client struct {
	restClient rest.Interface
}

func (c *VswitchV1alpha1Client) Vswitches(namespace string) VswitchInterface {
	return newVswitches(c, namespace)
}
