...
type FakeJobTemplates struct {
	Fake *FakeEhpcV1alpha1
	ns   string
}

var jobtemplatesResource = schema.GroupVersionResource{Group: "ehpc.alicloud.kubeform.com", Version: "v1alpha1", Resource: "jobtemplates"}

var jobtemplatesKind = schema.GroupVersionKind{Group: "ehpc.alicloud.kubeform.com", Version: "v1alpha1", Kind: "JobTemplate"}
...
func (c *FakeJobTemplates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(jobtemplatesResource, c.ns, name), &v1alpha1.JobTemplate{})
