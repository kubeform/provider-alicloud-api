...
var accessrulesResource = schema.GroupVersionResource{Group: "dfs.alicloud.kubeform.com", Version: "v1alpha1", Resource: "accessrules"}

var accessrulesKind = schema.GroupVersionKind{Group: "dfs.alicloud.kubeform.com", Version: "v1alpha1", Kind: "AccessRule"}
...
func (c *FakeAccessRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AccessRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(accessrulesResource, c.ns, name), &v1alpha1.AccessRule{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.AccessRule), err
}
...
func (c *FakeAccessRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AccessRuleList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(accessrulesResource, accessrulesKind, c.ns, opts), &v1alpha1.AccessRuleList{})
	...
	list := &v1alpha1.AccessRuleList{ListMeta: obj.(*v1alpha1.AccessRuleList).ListMeta}
	for _, item := range obj.(*v1alpha1.AccessRuleList).Items {
...
func (c *FakeAccessRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(accessrulesResource, c.ns, opts))
...
func (c *FakeAccessRules) Create(ctx context.Context, accessRule *v1alpha1.AccessRule, opts v1.CreateOptions) (result *v1alpha1.AccessRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(accessrulesResource, c.ns, accessRule), &v1alpha1.AccessRule{})
...
func (c *FakeAccessRules) Update(ctx context.Context, accessRule *v1alpha1.AccessRule, opts v1.UpdateOptions) (result *v1alpha1.AccessRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(accessrulesResource, c.ns, accessRule), &v1alpha1.AccessRule{})
...
func (c *FakeAccessRules) UpdateStatus(ctx context.Context, accessRule *v1alpha1.AccessRule, opts v1.UpdateOptions) (*v1alpha1.AccessRule, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(accessrulesResource, "status", c.ns, accessRule), &v1alpha1.AccessRule{})
...
func (c *FakeAccessRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(accessrulesResource, c.ns, name), &v1alpha1.AccessRule{})
...
func (c *FakeAccessRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(accessrulesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.AccessRuleList{})
	return err
}
...
func (c *FakeAccessRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AccessRule, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(accessrulesResource, c.ns, name, pt, data, subresources...), &v1alpha1.AccessRule{})
