...
func (c *DfsV1alpha1Client) MountPoints(namespace string) MountPointInterface {
	return newMountPoints(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*DfsV1alpha1Client, error) {
	...
	return &DfsV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DfsV1alpha1Client for the given config and
...
func New(c rest.Interface) *DfsV1alpha1Client {
	return &DfsV1alpha1Client{c}
}
