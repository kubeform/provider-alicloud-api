...
func newFileSystems(c *DfsV1alpha1Client, namespace string) *fileSystems {
	return &fileSystems{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *fileSystems) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FileSystem, err error) {
...
func (c *fileSystems) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FileSystemList, err error) {
...
func (c *fileSystems) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *fileSystems) Create(ctx context.Context, fileSystem *v1alpha1.FileSystem, opts v1.CreateOptions) (result *v1alpha1.FileSystem, err error) {
	result = &v1alpha1.FileSystem{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("filesystems").
...
func (c *fileSystems) Update(ctx context.Context, fileSystem *v1alpha1.FileSystem, opts v1.UpdateOptions) (result *v1alpha1.FileSystem, err error) {
	result = &v1alpha1.FileSystem{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("filesystems").
...
func (c *fileSystems) UpdateStatus(ctx context.Context, fileSystem *v1alpha1.FileSystem, opts v1.UpdateOptions) (result *v1alpha1.FileSystem, err error) {
	result = &v1alpha1.FileSystem{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("filesystems").
...
func (c *fileSystems) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *fileSystems) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *fileSystems) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FileSystem, err error) {
	result = &v1alpha1.FileSystem{}
