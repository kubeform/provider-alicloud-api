...
func newRepos(c *CrV1alpha1Client, namespace string) *repos {
	return &repos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *repos) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Repo, err error) {
...
func (c *repos) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RepoList, err error) {
...
func (c *repos) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *repos) Create(ctx context.Context, repo *v1alpha1.Repo, opts v1.CreateOptions) (result *v1alpha1.Repo, err error) {
	result = &v1alpha1.Repo{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("repos").
...
func (c *repos) Update(ctx context.Context, repo *v1alpha1.Repo, opts v1.UpdateOptions) (result *v1alpha1.Repo, err error) {
	result = &v1alpha1.Repo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("repos").
...
func (c *repos) UpdateStatus(ctx context.Context, repo *v1alpha1.Repo, opts v1.UpdateOptions) (result *v1alpha1.Repo, err error) {
	result = &v1alpha1.Repo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("repos").
...
func (c *repos) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *repos) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *repos) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Repo, err error) {
	result = &v1alpha1.Repo{}
