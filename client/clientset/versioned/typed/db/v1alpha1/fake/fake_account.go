...
var accountsResource = schema.GroupVersionResource{Group: "db.alicloud.kubeform.com", Version: "v1alpha1", Resource: "accounts"}

var accountsKind = schema.GroupVersionKind{Group: "db.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Account"}
