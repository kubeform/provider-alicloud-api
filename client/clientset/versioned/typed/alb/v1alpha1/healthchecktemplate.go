...
// HealthCheckTemplatesGetter has a method to return a HealthCheckTemplateInterface.
...
// healthCheckTemplates implements HealthCheckTemplateInterface
type healthCheckTemplates struct {
	client rest.Interface
	ns     string
}

// newHealthCheckTemplates returns a HealthCheckTemplates
func newHealthCheckTemplates(c *AlbV1alpha1Client, namespace string) *healthCheckTemplates {
...
func (c *healthCheckTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HealthCheckTemplate, err error) {
	result = &v1alpha1.HealthCheckTemplate{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *healthCheckTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HealthCheckTemplateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HealthCheckTemplateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("healthchecktemplates").
...
func (c *healthCheckTemplates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *healthCheckTemplates) Create(ctx context.Context, healthCheckTemplate *v1alpha1.HealthCheckTemplate, opts v1.CreateOptions) (result *v1alpha1.HealthCheckTemplate, err error) {
	result = &v1alpha1.HealthCheckTemplate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("healthchecktemplates").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(healthCheckTemplate).
		Do(ctx).
		Into(result)
	return
}
...
func (c *healthCheckTemplates) Update(ctx context.Context, healthCheckTemplate *v1alpha1.HealthCheckTemplate, opts v1.UpdateOptions) (result *v1alpha1.HealthCheckTemplate, err error) {
	result = &v1alpha1.HealthCheckTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("healthchecktemplates").
		Name(healthCheckTemplate.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(healthCheckTemplate).
		Do(ctx).
		Into(result)
...
func (c *healthCheckTemplates) UpdateStatus(ctx context.Context, healthCheckTemplate *v1alpha1.HealthCheckTemplate, opts v1.UpdateOptions) (result *v1alpha1.HealthCheckTemplate, err error) {
	result = &v1alpha1.HealthCheckTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("healthchecktemplates").
...
func (c *healthCheckTemplates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *healthCheckTemplates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *healthCheckTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HealthCheckTemplate, err error) {
	result = &v1alpha1.HealthCheckTemplate{}
