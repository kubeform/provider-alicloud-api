...
type FakeCertificates struct {
	Fake *FakeCasV1alpha1
	ns   string
}

var certificatesResource = schema.GroupVersionResource{Group: "cas.alicloud.kubeform.com", Version: "v1alpha1", Resource: "certificates"}

var certificatesKind = schema.GroupVersionKind{Group: "cas.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Certificate"}
