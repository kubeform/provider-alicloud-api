...
type FakeInstances struct {
	Fake *FakeEaisV1alpha1
	ns   string
}

var instancesResource = schema.GroupVersionResource{Group: "eais.alicloud.kubeform.com", Version: "v1alpha1", Resource: "instances"}

var instancesKind = schema.GroupVersionKind{Group: "eais.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Instance"}
