...
func NewForConfig(c *rest.Config) (*OtsV1alpha1Client, error) {
	...
	return &OtsV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new OtsV1alpha1Client for the given config and
...
func New(c rest.Interface) *OtsV1alpha1Client {
	return &OtsV1alpha1Client{c}
}
