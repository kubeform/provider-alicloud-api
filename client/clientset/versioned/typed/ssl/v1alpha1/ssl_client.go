...
func NewForConfig(c *rest.Config) (*SslV1alpha1Client, error) {
	...
	return &SslV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SslV1alpha1Client for the given config and
...
func New(c rest.Interface) *SslV1alpha1Client {
	return &SslV1alpha1Client{c}
}
