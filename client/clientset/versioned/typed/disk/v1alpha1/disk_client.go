...
// DiskV1alpha1Client is used to interact with features provided by the disk.alicloud.kubeform.com group.
type DiskV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DiskV1alpha1Client) Attachments(namespace string) AttachmentInterface {
	return newAttachments(c, namespace)
}

func (c *DiskV1alpha1Client) Disks(namespace string) DiskInterface {
