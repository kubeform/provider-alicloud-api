...
type PrivatelinkV1alpha1Interface interface {
	RESTClient() rest.Interface
	VpcEndpointsGetter
	VpcEndpointConnectionsGetter
	VpcEndpointServicesGetter
	VpcEndpointServiceResourcesGetter
	VpcEndpointServiceUsersGetter
	VpcEndpointZonesGetter
}
...
func (c *PrivatelinkV1alpha1Client) VpcEndpointConnections(namespace string) VpcEndpointConnectionInterface {
	return newVpcEndpointConnections(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*PrivatelinkV1alpha1Client, error) {
	...
	return &PrivatelinkV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new PrivatelinkV1alpha1Client for the given config and
...
func New(c rest.Interface) *PrivatelinkV1alpha1Client {
	return &PrivatelinkV1alpha1Client{c}
}
