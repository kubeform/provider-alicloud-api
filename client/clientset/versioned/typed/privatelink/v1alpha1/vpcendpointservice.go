...
func newVpcEndpointServices(c *PrivatelinkV1alpha1Client, namespace string) *vpcEndpointServices {
...
func (c *vpcEndpointServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VpcEndpointService, err error) {
...
func (c *vpcEndpointServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VpcEndpointServiceList, err error) {
...
func (c *vpcEndpointServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vpcEndpointServices) Create(ctx context.Context, vpcEndpointService *v1alpha1.VpcEndpointService, opts v1.CreateOptions) (result *v1alpha1.VpcEndpointService, err error) {
	result = &v1alpha1.VpcEndpointService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vpcendpointservices").
...
func (c *vpcEndpointServices) Update(ctx context.Context, vpcEndpointService *v1alpha1.VpcEndpointService, opts v1.UpdateOptions) (result *v1alpha1.VpcEndpointService, err error) {
	result = &v1alpha1.VpcEndpointService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpcendpointservices").
...
func (c *vpcEndpointServices) UpdateStatus(ctx context.Context, vpcEndpointService *v1alpha1.VpcEndpointService, opts v1.UpdateOptions) (result *v1alpha1.VpcEndpointService, err error) {
	result = &v1alpha1.VpcEndpointService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpcendpointservices").
...
func (c *vpcEndpointServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vpcEndpointServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vpcEndpointServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VpcEndpointService, err error) {
	result = &v1alpha1.VpcEndpointService{}
