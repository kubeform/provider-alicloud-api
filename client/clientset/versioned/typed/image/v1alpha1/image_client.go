...
// ImageV1alpha1Client is used to interact with features provided by the image.alicloud.kubeform.com group.
type ImageV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ImageV1alpha1Client) Copies(namespace string) CopyInterface {
	return newCopies(c, namespace)
}

func (c *ImageV1alpha1Client) Exports(namespace string) ExportInterface {
	return newExports(c, namespace)
}
...
func (c *ImageV1alpha1Client) Imports(namespace string) ImportInterface {
	return newImports(c, namespace)
}

func (c *ImageV1alpha1Client) SharePermissions(namespace string) SharePermissionInterface {
	return newSharePermissions(c, namespace)
}
