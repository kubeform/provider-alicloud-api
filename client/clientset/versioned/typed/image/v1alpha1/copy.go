...
// CopiesGetter has a method to return a CopyInterface.
...
// copies implements CopyInterface
type copies struct {
	client rest.Interface
	ns     string
}

// newCopies returns a Copies
func newCopies(c *ImageV1alpha1Client, namespace string) *copies {
	return &copies{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *copies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Copy, err error) {
	result = &v1alpha1.Copy{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("copies").
		Name(name).
...
func (c *copies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CopyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CopyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("copies").
...
func (c *copies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *copies) Create(ctx context.Context, copy *v1alpha1.Copy, opts v1.CreateOptions) (result *v1alpha1.Copy, err error) {
	result = &v1alpha1.Copy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("copies").
...
func (c *copies) Update(ctx context.Context, copy *v1alpha1.Copy, opts v1.UpdateOptions) (result *v1alpha1.Copy, err error) {
	result = &v1alpha1.Copy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("copies").
...
func (c *copies) UpdateStatus(ctx context.Context, copy *v1alpha1.Copy, opts v1.UpdateOptions) (result *v1alpha1.Copy, err error) {
	result = &v1alpha1.Copy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("copies").
...
func (c *copies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *copies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *copies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Copy, err error) {
	result = &v1alpha1.Copy{}
