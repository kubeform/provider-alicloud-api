...
func (c *MscV1alpha1Client) SubContacts(namespace string) SubContactInterface {
	return newSubContacts(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*MscV1alpha1Client, error) {
	...
	return &MscV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new MscV1alpha1Client for the given config and
...
func New(c rest.Interface) *MscV1alpha1Client {
	return &MscV1alpha1Client{c}
}
