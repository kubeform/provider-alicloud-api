...
type FakeTopicSubscriptions struct {
	Fake *FakeMnsV1alpha1
	ns   string
}

var topicsubscriptionsResource = schema.GroupVersionResource{Group: "mns.alicloud.kubeform.com", Version: "v1alpha1", Resource: "topicsubscriptions"}

var topicsubscriptionsKind = schema.GroupVersionKind{Group: "mns.alicloud.kubeform.com", Version: "v1alpha1", Kind: "TopicSubscription"}
