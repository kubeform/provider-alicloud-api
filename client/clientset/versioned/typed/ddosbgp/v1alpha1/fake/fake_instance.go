...
type FakeInstances struct {
	Fake *FakeDdosbgpV1alpha1
	ns   string
}

var instancesResource = schema.GroupVersionResource{Group: "ddosbgp.alicloud.kubeform.com", Version: "v1alpha1", Resource: "instances"}

var instancesKind = schema.GroupVersionKind{Group: "ddosbgp.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Instance"}
