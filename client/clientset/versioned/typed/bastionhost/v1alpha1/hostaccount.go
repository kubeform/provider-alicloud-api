...
// HostAccountsGetter has a method to return a HostAccountInterface.
...
// hostAccounts implements HostAccountInterface
type hostAccounts struct {
	client rest.Interface
	ns     string
}

// newHostAccounts returns a HostAccounts
func newHostAccounts(c *BastionhostV1alpha1Client, namespace string) *hostAccounts {
	return &hostAccounts{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *hostAccounts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HostAccount, err error) {
	result = &v1alpha1.HostAccount{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *hostAccounts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HostAccountList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HostAccountList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("hostaccounts").
...
func (c *hostAccounts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *hostAccounts) Create(ctx context.Context, hostAccount *v1alpha1.HostAccount, opts v1.CreateOptions) (result *v1alpha1.HostAccount, err error) {
	result = &v1alpha1.HostAccount{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("hostaccounts").
...
func (c *hostAccounts) Update(ctx context.Context, hostAccount *v1alpha1.HostAccount, opts v1.UpdateOptions) (result *v1alpha1.HostAccount, err error) {
	result = &v1alpha1.HostAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hostaccounts").
...
func (c *hostAccounts) UpdateStatus(ctx context.Context, hostAccount *v1alpha1.HostAccount, opts v1.UpdateOptions) (result *v1alpha1.HostAccount, err error) {
	result = &v1alpha1.HostAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hostaccounts").
...
func (c *hostAccounts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *hostAccounts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *hostAccounts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HostAccount, err error) {
	result = &v1alpha1.HostAccount{}
