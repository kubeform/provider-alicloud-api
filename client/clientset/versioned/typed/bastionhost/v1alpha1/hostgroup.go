...
func newHostGroups(c *BastionhostV1alpha1Client, namespace string) *hostGroups {
	return &hostGroups{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *hostGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HostGroup, err error) {
	result = &v1alpha1.HostGroup{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("hostgroups").
		Name(name).
...
func (c *hostGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HostGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HostGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("hostgroups").
...
func (c *hostGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *hostGroups) Create(ctx context.Context, hostGroup *v1alpha1.HostGroup, opts v1.CreateOptions) (result *v1alpha1.HostGroup, err error) {
	result = &v1alpha1.HostGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("hostgroups").
...
func (c *hostGroups) Update(ctx context.Context, hostGroup *v1alpha1.HostGroup, opts v1.UpdateOptions) (result *v1alpha1.HostGroup, err error) {
	result = &v1alpha1.HostGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hostgroups").
...
func (c *hostGroups) UpdateStatus(ctx context.Context, hostGroup *v1alpha1.HostGroup, opts v1.UpdateOptions) (result *v1alpha1.HostGroup, err error) {
	result = &v1alpha1.HostGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hostgroups").
...
func (c *hostGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *hostGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *hostGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HostGroup, err error) {
	result = &v1alpha1.HostGroup{}
