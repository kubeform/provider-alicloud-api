...
func newUserGroups(c *BastionhostV1alpha1Client, namespace string) *userGroups {
	return &userGroups{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *userGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UserGroup, err error) {
	result = &v1alpha1.UserGroup{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("usergroups").
		Name(name).
...
func (c *userGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UserGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.UserGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("usergroups").
...
func (c *userGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *userGroups) Create(ctx context.Context, userGroup *v1alpha1.UserGroup, opts v1.CreateOptions) (result *v1alpha1.UserGroup, err error) {
	result = &v1alpha1.UserGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("usergroups").
...
func (c *userGroups) Update(ctx context.Context, userGroup *v1alpha1.UserGroup, opts v1.UpdateOptions) (result *v1alpha1.UserGroup, err error) {
	result = &v1alpha1.UserGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("usergroups").
...
func (c *userGroups) UpdateStatus(ctx context.Context, userGroup *v1alpha1.UserGroup, opts v1.UpdateOptions) (result *v1alpha1.UserGroup, err error) {
	result = &v1alpha1.UserGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("usergroups").
...
func (c *userGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *userGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *userGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UserGroup, err error) {
	result = &v1alpha1.UserGroup{}
