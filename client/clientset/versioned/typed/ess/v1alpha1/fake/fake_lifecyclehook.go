...
var lifecyclehooksResource = schema.GroupVersionResource{Group: "ess.alicloud.kubeform.com", Version: "v1alpha1", Resource: "lifecyclehooks"}

var lifecyclehooksKind = schema.GroupVersionKind{Group: "ess.alicloud.kubeform.com", Version: "v1alpha1", Kind: "LifecycleHook"}

// Get takes name of the lifecycleHook, and returns the corresponding lifecycleHook object, and an error if there is any.
func (c *FakeLifecycleHooks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LifecycleHook, err error) {
	obj, err := c.Fake.
...
func (c *FakeLifecycleHooks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LifecycleHookList, err error) {
	obj, err := c.Fake.
...
func (c *FakeLifecycleHooks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeLifecycleHooks) Create(ctx context.Context, lifecycleHook *v1alpha1.LifecycleHook, opts v1.CreateOptions) (result *v1alpha1.LifecycleHook, err error) {
	obj, err := c.Fake.
...
func (c *FakeLifecycleHooks) Update(ctx context.Context, lifecycleHook *v1alpha1.LifecycleHook, opts v1.UpdateOptions) (result *v1alpha1.LifecycleHook, err error) {
	obj, err := c.Fake.
...
func (c *FakeLifecycleHooks) UpdateStatus(ctx context.Context, lifecycleHook *v1alpha1.LifecycleHook, opts v1.UpdateOptions) (*v1alpha1.LifecycleHook, error) {
	obj, err := c.Fake.
...
func (c *FakeLifecycleHooks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeLifecycleHooks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(lifecyclehooksResource, c.ns, listOpts)
...
func (c *FakeLifecycleHooks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LifecycleHook, err error) {
	obj, err := c.Fake.
