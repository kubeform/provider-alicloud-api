...
// ScalingConfigurationsGetter has a method to return a ScalingConfigurationInterface.
...
// scalingConfigurations implements ScalingConfigurationInterface
type scalingConfigurations struct {
	client rest.Interface
	ns     string
}

// newScalingConfigurations returns a ScalingConfigurations
func newScalingConfigurations(c *EssV1alpha1Client, namespace string) *scalingConfigurations {
...
func (c *scalingConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ScalingConfiguration, err error) {
	result = &v1alpha1.ScalingConfiguration{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *scalingConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ScalingConfigurationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ScalingConfigurationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("scalingconfigurations").
...
func (c *scalingConfigurations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *scalingConfigurations) Create(ctx context.Context, scalingConfiguration *v1alpha1.ScalingConfiguration, opts v1.CreateOptions) (result *v1alpha1.ScalingConfiguration, err error) {
	result = &v1alpha1.ScalingConfiguration{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("scalingconfigurations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(scalingConfiguration).
		Do(ctx).
		Into(result)
	return
}
...
func (c *scalingConfigurations) Update(ctx context.Context, scalingConfiguration *v1alpha1.ScalingConfiguration, opts v1.UpdateOptions) (result *v1alpha1.ScalingConfiguration, err error) {
	result = &v1alpha1.ScalingConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("scalingconfigurations").
		Name(scalingConfiguration.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(scalingConfiguration).
		Do(ctx).
		Into(result)
...
func (c *scalingConfigurations) UpdateStatus(ctx context.Context, scalingConfiguration *v1alpha1.ScalingConfiguration, opts v1.UpdateOptions) (result *v1alpha1.ScalingConfiguration, err error) {
	result = &v1alpha1.ScalingConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("scalingconfigurations").
...
func (c *scalingConfigurations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *scalingConfigurations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *scalingConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ScalingConfiguration, err error) {
	result = &v1alpha1.ScalingConfiguration{}
