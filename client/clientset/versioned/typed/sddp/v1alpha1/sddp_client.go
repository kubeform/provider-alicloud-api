...
func NewForConfig(c *rest.Config) (*SddpV1alpha1Client, error) {
	...
	return &SddpV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SddpV1alpha1Client for the given config and
...
func New(c rest.Interface) *SddpV1alpha1Client {
	return &SddpV1alpha1Client{c}
}
