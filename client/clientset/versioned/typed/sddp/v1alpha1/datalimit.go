...
// DataLimitsGetter has a method to return a DataLimitInterface.
...
// dataLimits implements DataLimitInterface
type dataLimits struct {
	client rest.Interface
	ns     string
}

// newDataLimits returns a DataLimits
func newDataLimits(c *SddpV1alpha1Client, namespace string) *dataLimits {
	return &dataLimits{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *dataLimits) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DataLimit, err error) {
	result = &v1alpha1.DataLimit{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("datalimits").
		Name(name).
...
func (c *dataLimits) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DataLimitList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DataLimitList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("datalimits").
...
func (c *dataLimits) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataLimits) Create(ctx context.Context, dataLimit *v1alpha1.DataLimit, opts v1.CreateOptions) (result *v1alpha1.DataLimit, err error) {
	result = &v1alpha1.DataLimit{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("datalimits").
...
func (c *dataLimits) Update(ctx context.Context, dataLimit *v1alpha1.DataLimit, opts v1.UpdateOptions) (result *v1alpha1.DataLimit, err error) {
	result = &v1alpha1.DataLimit{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datalimits").
...
func (c *dataLimits) UpdateStatus(ctx context.Context, dataLimit *v1alpha1.DataLimit, opts v1.UpdateOptions) (result *v1alpha1.DataLimit, err error) {
	result = &v1alpha1.DataLimit{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datalimits").
...
func (c *dataLimits) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dataLimits) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dataLimits) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DataLimit, err error) {
	result = &v1alpha1.DataLimit{}
