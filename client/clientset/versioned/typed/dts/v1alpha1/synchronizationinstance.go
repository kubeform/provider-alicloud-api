...
// SynchronizationInstancesGetter has a method to return a SynchronizationInstanceInterface.
...
// synchronizationInstances implements SynchronizationInstanceInterface
type synchronizationInstances struct {
	client rest.Interface
	ns     string
}

// newSynchronizationInstances returns a SynchronizationInstances
func newSynchronizationInstances(c *DtsV1alpha1Client, namespace string) *synchronizationInstances {
...
func (c *synchronizationInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SynchronizationInstance, err error) {
	result = &v1alpha1.SynchronizationInstance{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *synchronizationInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SynchronizationInstanceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SynchronizationInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("synchronizationinstances").
...
func (c *synchronizationInstances) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *synchronizationInstances) Create(ctx context.Context, synchronizationInstance *v1alpha1.SynchronizationInstance, opts v1.CreateOptions) (result *v1alpha1.SynchronizationInstance, err error) {
	result = &v1alpha1.SynchronizationInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("synchronizationinstances").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(synchronizationInstance).
		Do(ctx).
		Into(result)
	return
}
...
func (c *synchronizationInstances) Update(ctx context.Context, synchronizationInstance *v1alpha1.SynchronizationInstance, opts v1.UpdateOptions) (result *v1alpha1.SynchronizationInstance, err error) {
	result = &v1alpha1.SynchronizationInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("synchronizationinstances").
		Name(synchronizationInstance.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(synchronizationInstance).
		Do(ctx).
		Into(result)
...
func (c *synchronizationInstances) UpdateStatus(ctx context.Context, synchronizationInstance *v1alpha1.SynchronizationInstance, opts v1.UpdateOptions) (result *v1alpha1.SynchronizationInstance, err error) {
	result = &v1alpha1.SynchronizationInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("synchronizationinstances").
...
func (c *synchronizationInstances) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *synchronizationInstances) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *synchronizationInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SynchronizationInstance, err error) {
	result = &v1alpha1.SynchronizationInstance{}
