...
import (
	v1alpha1 "kubeform.dev/provider-alicloud-api/apis/emr/v1alpha1"
	"kubeform.dev/provider-alicloud-api/client/clientset/versioned/scheme"

	rest "k8s.io/client-go/rest"
)

type EmrV1alpha1Interface interface {
	RESTClient() rest.Interface
	ClustersGetter
}

// EmrV1alpha1Client is used to interact with features provided by the emr.alicloud.kubeform.com group.
...
func NewForConfig(c *rest.Config) (*EmrV1alpha1Client, error) {
	...
	return &EmrV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new EmrV1alpha1Client for the given config and
...
func New(c rest.Interface) *EmrV1alpha1Client {
	return &EmrV1alpha1Client{c}
}
