...
// BridgeRulesGetter has a method to return a BridgeRuleInterface.
...
// bridgeRules implements BridgeRuleInterface
type bridgeRules struct {
	client rest.Interface
	ns     string
}

// newBridgeRules returns a BridgeRules
func newBridgeRules(c *EventV1alpha1Client, namespace string) *bridgeRules {
	return &bridgeRules{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *bridgeRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BridgeRule, err error) {
	result = &v1alpha1.BridgeRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *bridgeRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BridgeRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BridgeRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("bridgerules").
...
func (c *bridgeRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *bridgeRules) Create(ctx context.Context, bridgeRule *v1alpha1.BridgeRule, opts v1.CreateOptions) (result *v1alpha1.BridgeRule, err error) {
	result = &v1alpha1.BridgeRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bridgerules").
...
func (c *bridgeRules) Update(ctx context.Context, bridgeRule *v1alpha1.BridgeRule, opts v1.UpdateOptions) (result *v1alpha1.BridgeRule, err error) {
	result = &v1alpha1.BridgeRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bridgerules").
		Name(bridgeRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(bridgeRule).
		Do(ctx).
		Into(result)
...
func (c *bridgeRules) UpdateStatus(ctx context.Context, bridgeRule *v1alpha1.BridgeRule, opts v1.UpdateOptions) (result *v1alpha1.BridgeRule, err error) {
	result = &v1alpha1.BridgeRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bridgerules").
...
func (c *bridgeRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *bridgeRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *bridgeRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BridgeRule, err error) {
	result = &v1alpha1.BridgeRule{}
