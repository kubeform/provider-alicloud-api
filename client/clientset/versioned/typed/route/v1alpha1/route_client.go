...
type RouteV1alpha1Interface interface {
	RESTClient() rest.Interface
	EntriesGetter
	TablesGetter
	TableAttachmentsGetter
}
...
func (c *RouteV1alpha1Client) TableAttachments(namespace string) TableAttachmentInterface {
	return newTableAttachments(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*RouteV1alpha1Client, error) {
	...
	return &RouteV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new RouteV1alpha1Client for the given config and
