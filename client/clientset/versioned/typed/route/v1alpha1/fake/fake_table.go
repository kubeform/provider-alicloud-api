...
var tablesResource = schema.GroupVersionResource{Group: "route.alicloud.kubeform.com", Version: "v1alpha1", Resource: "tables"}

var tablesKind = schema.GroupVersionKind{Group: "route.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Table"}
