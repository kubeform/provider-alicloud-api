...
import (
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/clientset/versioned/typed/dbfs/v1alpha1"

	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeDbfsV1alpha1 struct {
	*testing.Fake
}

func (c *FakeDbfsV1alpha1) Instances(namespace string) v1alpha1.InstanceInterface {
