...
// NetworkPackagesGetter has a method to return a NetworkPackageInterface.
...
// networkPackages implements NetworkPackageInterface
type networkPackages struct {
	client rest.Interface
	ns     string
}

// newNetworkPackages returns a NetworkPackages
func newNetworkPackages(c *EcdV1alpha1Client, namespace string) *networkPackages {
...
func (c *networkPackages) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkPackage, err error) {
	result = &v1alpha1.NetworkPackage{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *networkPackages) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkPackageList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NetworkPackageList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkpackages").
...
func (c *networkPackages) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkPackages) Create(ctx context.Context, networkPackage *v1alpha1.NetworkPackage, opts v1.CreateOptions) (result *v1alpha1.NetworkPackage, err error) {
	result = &v1alpha1.NetworkPackage{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkpackages").
...
func (c *networkPackages) Update(ctx context.Context, networkPackage *v1alpha1.NetworkPackage, opts v1.UpdateOptions) (result *v1alpha1.NetworkPackage, err error) {
	result = &v1alpha1.NetworkPackage{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkpackages").
		Name(networkPackage.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkPackage).
		Do(ctx).
		Into(result)
...
func (c *networkPackages) UpdateStatus(ctx context.Context, networkPackage *v1alpha1.NetworkPackage, opts v1.UpdateOptions) (result *v1alpha1.NetworkPackage, err error) {
	result = &v1alpha1.NetworkPackage{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkpackages").
...
func (c *networkPackages) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkPackages) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkPackages) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkPackage, err error) {
	result = &v1alpha1.NetworkPackage{}
