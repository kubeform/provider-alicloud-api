...
func (c *EcdV1alpha1Client) PolicyGroups(namespace string) PolicyGroupInterface {
	return newPolicyGroups(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*EcdV1alpha1Client, error) {
	...
	return &EcdV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new EcdV1alpha1Client for the given config and
...
func New(c rest.Interface) *EcdV1alpha1Client {
	return &EcdV1alpha1Client{c}
}
