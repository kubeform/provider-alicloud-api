...
type FakeInstances struct {
	Fake *FakeLindormV1alpha1
	ns   string
}

var instancesResource = schema.GroupVersionResource{Group: "lindorm.alicloud.kubeform.com", Version: "v1alpha1", Resource: "instances"}

var instancesKind = schema.GroupVersionKind{Group: "lindorm.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Instance"}
