...
func newKuberneteses(c *CsV1alpha1Client, namespace string) *kuberneteses {
	return &kuberneteses{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *kuberneteses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Kubernetes, err error) {
	result = &v1alpha1.Kubernetes{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *kuberneteses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KubernetesList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.KubernetesList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kuberneteses").
...
func (c *kuberneteses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kuberneteses) Create(ctx context.Context, kubernetes *v1alpha1.Kubernetes, opts v1.CreateOptions) (result *v1alpha1.Kubernetes, err error) {
	result = &v1alpha1.Kubernetes{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kuberneteses").
...
func (c *kuberneteses) Update(ctx context.Context, kubernetes *v1alpha1.Kubernetes, opts v1.UpdateOptions) (result *v1alpha1.Kubernetes, err error) {
	result = &v1alpha1.Kubernetes{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kuberneteses").
...
func (c *kuberneteses) UpdateStatus(ctx context.Context, kubernetes *v1alpha1.Kubernetes, opts v1.UpdateOptions) (result *v1alpha1.Kubernetes, err error) {
	result = &v1alpha1.Kubernetes{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kuberneteses").
...
func (c *kuberneteses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kuberneteses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kuberneteses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Kubernetes, err error) {
	result = &v1alpha1.Kubernetes{}
