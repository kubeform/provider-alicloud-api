...
func newKubernetesNodePools(c *CsV1alpha1Client, namespace string) *kubernetesNodePools {
...
func (c *kubernetesNodePools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KubernetesNodePool, err error) {
...
func (c *kubernetesNodePools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KubernetesNodePoolList, err error) {
...
func (c *kubernetesNodePools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kubernetesNodePools) Create(ctx context.Context, kubernetesNodePool *v1alpha1.KubernetesNodePool, opts v1.CreateOptions) (result *v1alpha1.KubernetesNodePool, err error) {
	result = &v1alpha1.KubernetesNodePool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kubernetesnodepools").
...
func (c *kubernetesNodePools) Update(ctx context.Context, kubernetesNodePool *v1alpha1.KubernetesNodePool, opts v1.UpdateOptions) (result *v1alpha1.KubernetesNodePool, err error) {
	result = &v1alpha1.KubernetesNodePool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kubernetesnodepools").
...
func (c *kubernetesNodePools) UpdateStatus(ctx context.Context, kubernetesNodePool *v1alpha1.KubernetesNodePool, opts v1.UpdateOptions) (result *v1alpha1.KubernetesNodePool, err error) {
	result = &v1alpha1.KubernetesNodePool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kubernetesnodepools").
...
func (c *kubernetesNodePools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kubernetesNodePools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kubernetesNodePools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KubernetesNodePool, err error) {
	result = &v1alpha1.KubernetesNodePool{}
