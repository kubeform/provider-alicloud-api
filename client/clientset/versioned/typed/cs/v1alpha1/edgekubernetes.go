...
// EdgeKubernetesesGetter has a method to return a EdgeKubernetesInterface.
...
// edgeKuberneteses implements EdgeKubernetesInterface
type edgeKuberneteses struct {
	client rest.Interface
	ns     string
}

// newEdgeKuberneteses returns a EdgeKuberneteses
func newEdgeKuberneteses(c *CsV1alpha1Client, namespace string) *edgeKuberneteses {
	return &edgeKuberneteses{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *edgeKuberneteses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EdgeKubernetes, err error) {
	result = &v1alpha1.EdgeKubernetes{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("edgekuberneteses").
		Name(name).
...
func (c *edgeKuberneteses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EdgeKubernetesList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EdgeKubernetesList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("edgekuberneteses").
...
func (c *edgeKuberneteses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *edgeKuberneteses) Create(ctx context.Context, edgeKubernetes *v1alpha1.EdgeKubernetes, opts v1.CreateOptions) (result *v1alpha1.EdgeKubernetes, err error) {
	result = &v1alpha1.EdgeKubernetes{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("edgekuberneteses").
...
func (c *edgeKuberneteses) Update(ctx context.Context, edgeKubernetes *v1alpha1.EdgeKubernetes, opts v1.UpdateOptions) (result *v1alpha1.EdgeKubernetes, err error) {
	result = &v1alpha1.EdgeKubernetes{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("edgekuberneteses").
		Name(edgeKubernetes.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(edgeKubernetes).
		Do(ctx).
		Into(result)
...
func (c *edgeKuberneteses) UpdateStatus(ctx context.Context, edgeKubernetes *v1alpha1.EdgeKubernetes, opts v1.UpdateOptions) (result *v1alpha1.EdgeKubernetes, err error) {
	result = &v1alpha1.EdgeKubernetes{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("edgekuberneteses").
...
func (c *edgeKuberneteses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *edgeKuberneteses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *edgeKuberneteses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EdgeKubernetes, err error) {
	result = &v1alpha1.EdgeKubernetes{}
