...
// KubernetesPermissionsesGetter has a method to return a KubernetesPermissionsInterface.
...
// kubernetesPermissionses implements KubernetesPermissionsInterface
type kubernetesPermissionses struct {
	client rest.Interface
	ns     string
}

// newKubernetesPermissionses returns a KubernetesPermissionses
func newKubernetesPermissionses(c *CsV1alpha1Client, namespace string) *kubernetesPermissionses {
	return &kubernetesPermissionses{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *kubernetesPermissionses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KubernetesPermissions, err error) {
	result = &v1alpha1.KubernetesPermissions{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kubernetespermissionses").
		Name(name).
...
func (c *kubernetesPermissionses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KubernetesPermissionsList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.KubernetesPermissionsList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kubernetespermissionses").
...
func (c *kubernetesPermissionses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kubernetesPermissionses) Create(ctx context.Context, kubernetesPermissions *v1alpha1.KubernetesPermissions, opts v1.CreateOptions) (result *v1alpha1.KubernetesPermissions, err error) {
	result = &v1alpha1.KubernetesPermissions{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kubernetespermissionses").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(kubernetesPermissions).
		Do(ctx).
		Into(result)
	return
}
...
func (c *kubernetesPermissionses) Update(ctx context.Context, kubernetesPermissions *v1alpha1.KubernetesPermissions, opts v1.UpdateOptions) (result *v1alpha1.KubernetesPermissions, err error) {
	result = &v1alpha1.KubernetesPermissions{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kubernetespermissionses").
		Name(kubernetesPermissions.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(kubernetesPermissions).
		Do(ctx).
		Into(result)
...
func (c *kubernetesPermissionses) UpdateStatus(ctx context.Context, kubernetesPermissions *v1alpha1.KubernetesPermissions, opts v1.UpdateOptions) (result *v1alpha1.KubernetesPermissions, err error) {
	result = &v1alpha1.KubernetesPermissions{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kubernetespermissionses").
...
func (c *kubernetesPermissionses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kubernetesPermissionses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kubernetesPermissionses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KubernetesPermissions, err error) {
	result = &v1alpha1.KubernetesPermissions{}
