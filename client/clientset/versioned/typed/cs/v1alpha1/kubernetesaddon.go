...
// KubernetesAddonsGetter has a method to return a KubernetesAddonInterface.
...
// kubernetesAddons implements KubernetesAddonInterface
type kubernetesAddons struct {
	client rest.Interface
	ns     string
}

// newKubernetesAddons returns a KubernetesAddons
func newKubernetesAddons(c *CsV1alpha1Client, namespace string) *kubernetesAddons {
...
func (c *kubernetesAddons) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KubernetesAddon, err error) {
	result = &v1alpha1.KubernetesAddon{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *kubernetesAddons) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KubernetesAddonList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.KubernetesAddonList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kubernetesaddons").
...
func (c *kubernetesAddons) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kubernetesAddons) Create(ctx context.Context, kubernetesAddon *v1alpha1.KubernetesAddon, opts v1.CreateOptions) (result *v1alpha1.KubernetesAddon, err error) {
	result = &v1alpha1.KubernetesAddon{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kubernetesaddons").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(kubernetesAddon).
		Do(ctx).
		Into(result)
	return
}
...
func (c *kubernetesAddons) Update(ctx context.Context, kubernetesAddon *v1alpha1.KubernetesAddon, opts v1.UpdateOptions) (result *v1alpha1.KubernetesAddon, err error) {
	result = &v1alpha1.KubernetesAddon{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kubernetesaddons").
		Name(kubernetesAddon.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(kubernetesAddon).
		Do(ctx).
		Into(result)
...
func (c *kubernetesAddons) UpdateStatus(ctx context.Context, kubernetesAddon *v1alpha1.KubernetesAddon, opts v1.UpdateOptions) (result *v1alpha1.KubernetesAddon, err error) {
	result = &v1alpha1.KubernetesAddon{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kubernetesaddons").
...
func (c *kubernetesAddons) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kubernetesAddons) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kubernetesAddons) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KubernetesAddon, err error) {
	result = &v1alpha1.KubernetesAddon{}
