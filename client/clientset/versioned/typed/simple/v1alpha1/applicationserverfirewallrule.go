...
// ApplicationServerFirewallRulesGetter has a method to return a ApplicationServerFirewallRuleInterface.
...
// applicationServerFirewallRules implements ApplicationServerFirewallRuleInterface
type applicationServerFirewallRules struct {
	client rest.Interface
	ns     string
}

// newApplicationServerFirewallRules returns a ApplicationServerFirewallRules
func newApplicationServerFirewallRules(c *SimpleV1alpha1Client, namespace string) *applicationServerFirewallRules {
	return &applicationServerFirewallRules{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *applicationServerFirewallRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApplicationServerFirewallRule, err error) {
	result = &v1alpha1.ApplicationServerFirewallRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *applicationServerFirewallRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApplicationServerFirewallRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApplicationServerFirewallRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("applicationserverfirewallrules").
...
func (c *applicationServerFirewallRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *applicationServerFirewallRules) Create(ctx context.Context, applicationServerFirewallRule *v1alpha1.ApplicationServerFirewallRule, opts v1.CreateOptions) (result *v1alpha1.ApplicationServerFirewallRule, err error) {
	result = &v1alpha1.ApplicationServerFirewallRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("applicationserverfirewallrules").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(applicationServerFirewallRule).
		Do(ctx).
		Into(result)
	return
}
...
func (c *applicationServerFirewallRules) Update(ctx context.Context, applicationServerFirewallRule *v1alpha1.ApplicationServerFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.ApplicationServerFirewallRule, err error) {
	result = &v1alpha1.ApplicationServerFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applicationserverfirewallrules").
		Name(applicationServerFirewallRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(applicationServerFirewallRule).
		Do(ctx).
		Into(result)
...
func (c *applicationServerFirewallRules) UpdateStatus(ctx context.Context, applicationServerFirewallRule *v1alpha1.ApplicationServerFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.ApplicationServerFirewallRule, err error) {
	result = &v1alpha1.ApplicationServerFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applicationserverfirewallrules").
...
func (c *applicationServerFirewallRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *applicationServerFirewallRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *applicationServerFirewallRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApplicationServerFirewallRule, err error) {
	result = &v1alpha1.ApplicationServerFirewallRule{}
