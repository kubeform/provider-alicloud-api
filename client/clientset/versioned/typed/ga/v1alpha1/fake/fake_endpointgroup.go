...
var endpointgroupsResource = schema.GroupVersionResource{Group: "ga.alicloud.kubeform.com", Version: "v1alpha1", Resource: "endpointgroups"}

var endpointgroupsKind = schema.GroupVersionKind{Group: "ga.alicloud.kubeform.com", Version: "v1alpha1", Kind: "EndpointGroup"}
...
func (c *FakeEndpointGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EndpointGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(endpointgroupsResource, c.ns, name), &v1alpha1.EndpointGroup{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EndpointGroup), err
}
...
func (c *FakeEndpointGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(endpointgroupsResource, endpointgroupsKind, c.ns, opts), &v1alpha1.EndpointGroupList{})
	...
	list := &v1alpha1.EndpointGroupList{ListMeta: obj.(*v1alpha1.EndpointGroupList).ListMeta}
	for _, item := range obj.(*v1alpha1.EndpointGroupList).Items {
...
func (c *FakeEndpointGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(endpointgroupsResource, c.ns, opts))
...
func (c *FakeEndpointGroups) Create(ctx context.Context, endpointGroup *v1alpha1.EndpointGroup, opts v1.CreateOptions) (result *v1alpha1.EndpointGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(endpointgroupsResource, c.ns, endpointGroup), &v1alpha1.EndpointGroup{})
...
func (c *FakeEndpointGroups) Update(ctx context.Context, endpointGroup *v1alpha1.EndpointGroup, opts v1.UpdateOptions) (result *v1alpha1.EndpointGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(endpointgroupsResource, c.ns, endpointGroup), &v1alpha1.EndpointGroup{})
...
func (c *FakeEndpointGroups) UpdateStatus(ctx context.Context, endpointGroup *v1alpha1.EndpointGroup, opts v1.UpdateOptions) (*v1alpha1.EndpointGroup, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(endpointgroupsResource, "status", c.ns, endpointGroup), &v1alpha1.EndpointGroup{})
...
func (c *FakeEndpointGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(endpointgroupsResource, c.ns, name), &v1alpha1.EndpointGroup{})
...
func (c *FakeEndpointGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(endpointgroupsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.EndpointGroupList{})
	return err
}
...
func (c *FakeEndpointGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EndpointGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(endpointgroupsResource, c.ns, name, pt, data, subresources...), &v1alpha1.EndpointGroup{})
