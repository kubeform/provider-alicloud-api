...
var acceleratorsResource = schema.GroupVersionResource{Group: "ga.alicloud.kubeform.com", Version: "v1alpha1", Resource: "accelerators"}

var acceleratorsKind = schema.GroupVersionKind{Group: "ga.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Accelerator"}
...
func (c *FakeAccelerators) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Accelerator, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(acceleratorsResource, c.ns, name), &v1alpha1.Accelerator{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Accelerator), err
}
...
func (c *FakeAccelerators) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AcceleratorList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(acceleratorsResource, acceleratorsKind, c.ns, opts), &v1alpha1.AcceleratorList{})
	...
	list := &v1alpha1.AcceleratorList{ListMeta: obj.(*v1alpha1.AcceleratorList).ListMeta}
	for _, item := range obj.(*v1alpha1.AcceleratorList).Items {
...
func (c *FakeAccelerators) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(acceleratorsResource, c.ns, opts))
...
func (c *FakeAccelerators) Create(ctx context.Context, accelerator *v1alpha1.Accelerator, opts v1.CreateOptions) (result *v1alpha1.Accelerator, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(acceleratorsResource, c.ns, accelerator), &v1alpha1.Accelerator{})
...
func (c *FakeAccelerators) Update(ctx context.Context, accelerator *v1alpha1.Accelerator, opts v1.UpdateOptions) (result *v1alpha1.Accelerator, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(acceleratorsResource, c.ns, accelerator), &v1alpha1.Accelerator{})
...
func (c *FakeAccelerators) UpdateStatus(ctx context.Context, accelerator *v1alpha1.Accelerator, opts v1.UpdateOptions) (*v1alpha1.Accelerator, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(acceleratorsResource, "status", c.ns, accelerator), &v1alpha1.Accelerator{})
...
func (c *FakeAccelerators) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(acceleratorsResource, c.ns, name), &v1alpha1.Accelerator{})
...
func (c *FakeAccelerators) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(acceleratorsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.AcceleratorList{})
	return err
}
...
func (c *FakeAccelerators) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Accelerator, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(acceleratorsResource, c.ns, name, pt, data, subresources...), &v1alpha1.Accelerator{})
