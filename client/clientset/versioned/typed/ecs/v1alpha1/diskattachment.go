...
// DiskAttachmentsGetter has a method to return a DiskAttachmentInterface.
...
// diskAttachments implements DiskAttachmentInterface
type diskAttachments struct {
	client rest.Interface
	ns     string
}

// newDiskAttachments returns a DiskAttachments
func newDiskAttachments(c *EcsV1alpha1Client, namespace string) *diskAttachments {
...
func (c *diskAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DiskAttachment, err error) {
	result = &v1alpha1.DiskAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *diskAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DiskAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DiskAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("diskattachments").
...
func (c *diskAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *diskAttachments) Create(ctx context.Context, diskAttachment *v1alpha1.DiskAttachment, opts v1.CreateOptions) (result *v1alpha1.DiskAttachment, err error) {
	result = &v1alpha1.DiskAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("diskattachments").
...
func (c *diskAttachments) Update(ctx context.Context, diskAttachment *v1alpha1.DiskAttachment, opts v1.UpdateOptions) (result *v1alpha1.DiskAttachment, err error) {
	result = &v1alpha1.DiskAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("diskattachments").
		Name(diskAttachment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(diskAttachment).
		Do(ctx).
		Into(result)
...
func (c *diskAttachments) UpdateStatus(ctx context.Context, diskAttachment *v1alpha1.DiskAttachment, opts v1.UpdateOptions) (result *v1alpha1.DiskAttachment, err error) {
	result = &v1alpha1.DiskAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("diskattachments").
...
func (c *diskAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *diskAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *diskAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DiskAttachment, err error) {
	result = &v1alpha1.DiskAttachment{}
