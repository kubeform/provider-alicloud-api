...
var prefixlistsResource = schema.GroupVersionResource{Group: "ecs.alicloud.kubeform.com", Version: "v1alpha1", Resource: "prefixlists"}

var prefixlistsKind = schema.GroupVersionKind{Group: "ecs.alicloud.kubeform.com", Version: "v1alpha1", Kind: "PrefixList"}
...
func (c *FakePrefixLists) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PrefixList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(prefixlistsResource, c.ns, name), &v1alpha1.PrefixList{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.PrefixList), err
}
...
func (c *FakePrefixLists) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PrefixListList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(prefixlistsResource, prefixlistsKind, c.ns, opts), &v1alpha1.PrefixListList{})
	...
	list := &v1alpha1.PrefixListList{ListMeta: obj.(*v1alpha1.PrefixListList).ListMeta}
	for _, item := range obj.(*v1alpha1.PrefixListList).Items {
...
func (c *FakePrefixLists) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(prefixlistsResource, c.ns, opts))
...
func (c *FakePrefixLists) Create(ctx context.Context, prefixList *v1alpha1.PrefixList, opts v1.CreateOptions) (result *v1alpha1.PrefixList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(prefixlistsResource, c.ns, prefixList), &v1alpha1.PrefixList{})
...
func (c *FakePrefixLists) Update(ctx context.Context, prefixList *v1alpha1.PrefixList, opts v1.UpdateOptions) (result *v1alpha1.PrefixList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(prefixlistsResource, c.ns, prefixList), &v1alpha1.PrefixList{})
...
func (c *FakePrefixLists) UpdateStatus(ctx context.Context, prefixList *v1alpha1.PrefixList, opts v1.UpdateOptions) (*v1alpha1.PrefixList, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(prefixlistsResource, "status", c.ns, prefixList), &v1alpha1.PrefixList{})
...
func (c *FakePrefixLists) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(prefixlistsResource, c.ns, name), &v1alpha1.PrefixList{})
...
func (c *FakePrefixLists) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(prefixlistsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.PrefixListList{})
	return err
}
...
func (c *FakePrefixLists) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PrefixList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(prefixlistsResource, c.ns, name, pt, data, subresources...), &v1alpha1.PrefixList{})
