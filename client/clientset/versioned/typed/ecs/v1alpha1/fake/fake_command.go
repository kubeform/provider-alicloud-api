...
var commandsResource = schema.GroupVersionResource{Group: "ecs.alicloud.kubeform.com", Version: "v1alpha1", Resource: "commands"}

var commandsKind = schema.GroupVersionKind{Group: "ecs.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Command"}
...
func (c *FakeCommands) UpdateStatus(ctx context.Context, command *v1alpha1.Command, opts v1.UpdateOptions) (*v1alpha1.Command, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(commandsResource, "status", c.ns, command), &v1alpha1.Command{})
