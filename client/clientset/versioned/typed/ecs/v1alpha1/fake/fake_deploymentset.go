...
var deploymentsetsResource = schema.GroupVersionResource{Group: "ecs.alicloud.kubeform.com", Version: "v1alpha1", Resource: "deploymentsets"}

var deploymentsetsKind = schema.GroupVersionKind{Group: "ecs.alicloud.kubeform.com", Version: "v1alpha1", Kind: "DeploymentSet"}
...
func (c *FakeDeploymentSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DeploymentSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(deploymentsetsResource, c.ns, name), &v1alpha1.DeploymentSet{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DeploymentSet), err
}
...
func (c *FakeDeploymentSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DeploymentSetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(deploymentsetsResource, deploymentsetsKind, c.ns, opts), &v1alpha1.DeploymentSetList{})
	...
	list := &v1alpha1.DeploymentSetList{ListMeta: obj.(*v1alpha1.DeploymentSetList).ListMeta}
	for _, item := range obj.(*v1alpha1.DeploymentSetList).Items {
...
func (c *FakeDeploymentSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(deploymentsetsResource, c.ns, opts))
...
func (c *FakeDeploymentSets) Create(ctx context.Context, deploymentSet *v1alpha1.DeploymentSet, opts v1.CreateOptions) (result *v1alpha1.DeploymentSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(deploymentsetsResource, c.ns, deploymentSet), &v1alpha1.DeploymentSet{})
...
func (c *FakeDeploymentSets) Update(ctx context.Context, deploymentSet *v1alpha1.DeploymentSet, opts v1.UpdateOptions) (result *v1alpha1.DeploymentSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(deploymentsetsResource, c.ns, deploymentSet), &v1alpha1.DeploymentSet{})
...
func (c *FakeDeploymentSets) UpdateStatus(ctx context.Context, deploymentSet *v1alpha1.DeploymentSet, opts v1.UpdateOptions) (*v1alpha1.DeploymentSet, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(deploymentsetsResource, "status", c.ns, deploymentSet), &v1alpha1.DeploymentSet{})
...
func (c *FakeDeploymentSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(deploymentsetsResource, c.ns, name), &v1alpha1.DeploymentSet{})
...
func (c *FakeDeploymentSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(deploymentsetsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.DeploymentSetList{})
	return err
}
...
func (c *FakeDeploymentSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DeploymentSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(deploymentsetsResource, c.ns, name, pt, data, subresources...), &v1alpha1.DeploymentSet{})
