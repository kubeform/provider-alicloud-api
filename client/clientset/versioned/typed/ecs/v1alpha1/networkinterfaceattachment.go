...
func newNetworkInterfaceAttachments(c *EcsV1alpha1Client, namespace string) *networkInterfaceAttachments {
...
func (c *networkInterfaceAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkInterfaceAttachment, err error) {
...
func (c *networkInterfaceAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkInterfaceAttachmentList, err error) {
...
func (c *networkInterfaceAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkInterfaceAttachments) Create(ctx context.Context, networkInterfaceAttachment *v1alpha1.NetworkInterfaceAttachment, opts v1.CreateOptions) (result *v1alpha1.NetworkInterfaceAttachment, err error) {
	result = &v1alpha1.NetworkInterfaceAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkinterfaceattachments").
...
func (c *networkInterfaceAttachments) Update(ctx context.Context, networkInterfaceAttachment *v1alpha1.NetworkInterfaceAttachment, opts v1.UpdateOptions) (result *v1alpha1.NetworkInterfaceAttachment, err error) {
	result = &v1alpha1.NetworkInterfaceAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkinterfaceattachments").
...
func (c *networkInterfaceAttachments) UpdateStatus(ctx context.Context, networkInterfaceAttachment *v1alpha1.NetworkInterfaceAttachment, opts v1.UpdateOptions) (result *v1alpha1.NetworkInterfaceAttachment, err error) {
	result = &v1alpha1.NetworkInterfaceAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkinterfaceattachments").
...
func (c *networkInterfaceAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkInterfaceAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkInterfaceAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkInterfaceAttachment, err error) {
	result = &v1alpha1.NetworkInterfaceAttachment{}
