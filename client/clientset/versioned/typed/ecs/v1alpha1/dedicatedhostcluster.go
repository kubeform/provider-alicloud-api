...
// DedicatedHostClustersGetter has a method to return a DedicatedHostClusterInterface.
...
// dedicatedHostClusters implements DedicatedHostClusterInterface
type dedicatedHostClusters struct {
	client rest.Interface
	ns     string
}

// newDedicatedHostClusters returns a DedicatedHostClusters
func newDedicatedHostClusters(c *EcsV1alpha1Client, namespace string) *dedicatedHostClusters {
...
func (c *dedicatedHostClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DedicatedHostCluster, err error) {
	result = &v1alpha1.DedicatedHostCluster{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dedicatedHostClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DedicatedHostClusterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DedicatedHostClusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dedicatedhostclusters").
...
func (c *dedicatedHostClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dedicatedHostClusters) Create(ctx context.Context, dedicatedHostCluster *v1alpha1.DedicatedHostCluster, opts v1.CreateOptions) (result *v1alpha1.DedicatedHostCluster, err error) {
	result = &v1alpha1.DedicatedHostCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dedicatedhostclusters").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dedicatedHostCluster).
		Do(ctx).
		Into(result)
	return
}
...
func (c *dedicatedHostClusters) Update(ctx context.Context, dedicatedHostCluster *v1alpha1.DedicatedHostCluster, opts v1.UpdateOptions) (result *v1alpha1.DedicatedHostCluster, err error) {
	result = &v1alpha1.DedicatedHostCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dedicatedhostclusters").
		Name(dedicatedHostCluster.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dedicatedHostCluster).
		Do(ctx).
		Into(result)
...
func (c *dedicatedHostClusters) UpdateStatus(ctx context.Context, dedicatedHostCluster *v1alpha1.DedicatedHostCluster, opts v1.UpdateOptions) (result *v1alpha1.DedicatedHostCluster, err error) {
	result = &v1alpha1.DedicatedHostCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dedicatedhostclusters").
...
func (c *dedicatedHostClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dedicatedHostClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dedicatedHostClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DedicatedHostCluster, err error) {
	result = &v1alpha1.DedicatedHostCluster{}
