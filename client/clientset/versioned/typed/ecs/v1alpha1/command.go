...
func newCommands(c *EcsV1alpha1Client, namespace string) *commands {
	return &commands{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *commands) UpdateStatus(ctx context.Context, command *v1alpha1.Command, opts v1.UpdateOptions) (result *v1alpha1.Command, err error) {
	result = &v1alpha1.Command{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("commands").
