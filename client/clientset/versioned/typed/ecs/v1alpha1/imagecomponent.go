...
// ImageComponentsGetter has a method to return a ImageComponentInterface.
...
// imageComponents implements ImageComponentInterface
type imageComponents struct {
	client rest.Interface
	ns     string
}

// newImageComponents returns a ImageComponents
func newImageComponents(c *EcsV1alpha1Client, namespace string) *imageComponents {
...
func (c *imageComponents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ImageComponent, err error) {
	result = &v1alpha1.ImageComponent{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *imageComponents) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ImageComponentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ImageComponentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("imagecomponents").
...
func (c *imageComponents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *imageComponents) Create(ctx context.Context, imageComponent *v1alpha1.ImageComponent, opts v1.CreateOptions) (result *v1alpha1.ImageComponent, err error) {
	result = &v1alpha1.ImageComponent{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("imagecomponents").
...
func (c *imageComponents) Update(ctx context.Context, imageComponent *v1alpha1.ImageComponent, opts v1.UpdateOptions) (result *v1alpha1.ImageComponent, err error) {
	result = &v1alpha1.ImageComponent{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imagecomponents").
...
func (c *imageComponents) UpdateStatus(ctx context.Context, imageComponent *v1alpha1.ImageComponent, opts v1.UpdateOptions) (result *v1alpha1.ImageComponent, err error) {
	result = &v1alpha1.ImageComponent{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("imagecomponents").
...
func (c *imageComponents) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *imageComponents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *imageComponents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ImageComponent, err error) {
	result = &v1alpha1.ImageComponent{}
