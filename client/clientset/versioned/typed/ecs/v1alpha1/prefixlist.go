...
// PrefixListsGetter has a method to return a PrefixListInterface.
...
// prefixLists implements PrefixListInterface
type prefixLists struct {
	client rest.Interface
	ns     string
}

// newPrefixLists returns a PrefixLists
func newPrefixLists(c *EcsV1alpha1Client, namespace string) *prefixLists {
	return &prefixLists{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *prefixLists) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PrefixList, err error) {
...
func (c *prefixLists) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PrefixListList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PrefixListList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("prefixlists").
...
func (c *prefixLists) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *prefixLists) Create(ctx context.Context, prefixList *v1alpha1.PrefixList, opts v1.CreateOptions) (result *v1alpha1.PrefixList, err error) {
	result = &v1alpha1.PrefixList{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("prefixlists").
...
func (c *prefixLists) Update(ctx context.Context, prefixList *v1alpha1.PrefixList, opts v1.UpdateOptions) (result *v1alpha1.PrefixList, err error) {
	result = &v1alpha1.PrefixList{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("prefixlists").
...
func (c *prefixLists) UpdateStatus(ctx context.Context, prefixList *v1alpha1.PrefixList, opts v1.UpdateOptions) (result *v1alpha1.PrefixList, err error) {
	result = &v1alpha1.PrefixList{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("prefixlists").
...
func (c *prefixLists) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *prefixLists) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *prefixLists) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PrefixList, err error) {
	result = &v1alpha1.PrefixList{}
