...
// AutoSnapshotPolicyAttachmentsGetter has a method to return a AutoSnapshotPolicyAttachmentInterface.
...
// autoSnapshotPolicyAttachments implements AutoSnapshotPolicyAttachmentInterface
type autoSnapshotPolicyAttachments struct {
	client rest.Interface
	ns     string
}

// newAutoSnapshotPolicyAttachments returns a AutoSnapshotPolicyAttachments
func newAutoSnapshotPolicyAttachments(c *EcsV1alpha1Client, namespace string) *autoSnapshotPolicyAttachments {
	return &autoSnapshotPolicyAttachments{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *autoSnapshotPolicyAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutoSnapshotPolicyAttachment, err error) {
	result = &v1alpha1.AutoSnapshotPolicyAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *autoSnapshotPolicyAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutoSnapshotPolicyAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AutoSnapshotPolicyAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("autosnapshotpolicyattachments").
...
func (c *autoSnapshotPolicyAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *autoSnapshotPolicyAttachments) Create(ctx context.Context, autoSnapshotPolicyAttachment *v1alpha1.AutoSnapshotPolicyAttachment, opts v1.CreateOptions) (result *v1alpha1.AutoSnapshotPolicyAttachment, err error) {
	result = &v1alpha1.AutoSnapshotPolicyAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("autosnapshotpolicyattachments").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(autoSnapshotPolicyAttachment).
		Do(ctx).
		Into(result)
	return
}
...
func (c *autoSnapshotPolicyAttachments) Update(ctx context.Context, autoSnapshotPolicyAttachment *v1alpha1.AutoSnapshotPolicyAttachment, opts v1.UpdateOptions) (result *v1alpha1.AutoSnapshotPolicyAttachment, err error) {
	result = &v1alpha1.AutoSnapshotPolicyAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("autosnapshotpolicyattachments").
		Name(autoSnapshotPolicyAttachment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(autoSnapshotPolicyAttachment).
		Do(ctx).
		Into(result)
...
func (c *autoSnapshotPolicyAttachments) UpdateStatus(ctx context.Context, autoSnapshotPolicyAttachment *v1alpha1.AutoSnapshotPolicyAttachment, opts v1.UpdateOptions) (result *v1alpha1.AutoSnapshotPolicyAttachment, err error) {
	result = &v1alpha1.AutoSnapshotPolicyAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("autosnapshotpolicyattachments").
...
func (c *autoSnapshotPolicyAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *autoSnapshotPolicyAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *autoSnapshotPolicyAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutoSnapshotPolicyAttachment, err error) {
	result = &v1alpha1.AutoSnapshotPolicyAttachment{}
