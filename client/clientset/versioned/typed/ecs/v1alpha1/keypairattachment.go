...
// KeyPairAttachmentsGetter has a method to return a KeyPairAttachmentInterface.
...
// keyPairAttachments implements KeyPairAttachmentInterface
type keyPairAttachments struct {
	client rest.Interface
	ns     string
}

// newKeyPairAttachments returns a KeyPairAttachments
func newKeyPairAttachments(c *EcsV1alpha1Client, namespace string) *keyPairAttachments {
	return &keyPairAttachments{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *keyPairAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KeyPairAttachment, err error) {
	result = &v1alpha1.KeyPairAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *keyPairAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KeyPairAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.KeyPairAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("keypairattachments").
...
func (c *keyPairAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *keyPairAttachments) Create(ctx context.Context, keyPairAttachment *v1alpha1.KeyPairAttachment, opts v1.CreateOptions) (result *v1alpha1.KeyPairAttachment, err error) {
	result = &v1alpha1.KeyPairAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("keypairattachments").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(keyPairAttachment).
		Do(ctx).
		Into(result)
	return
}
...
func (c *keyPairAttachments) Update(ctx context.Context, keyPairAttachment *v1alpha1.KeyPairAttachment, opts v1.UpdateOptions) (result *v1alpha1.KeyPairAttachment, err error) {
	result = &v1alpha1.KeyPairAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keypairattachments").
		Name(keyPairAttachment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(keyPairAttachment).
		Do(ctx).
		Into(result)
...
func (c *keyPairAttachments) UpdateStatus(ctx context.Context, keyPairAttachment *v1alpha1.KeyPairAttachment, opts v1.UpdateOptions) (result *v1alpha1.KeyPairAttachment, err error) {
	result = &v1alpha1.KeyPairAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("keypairattachments").
...
func (c *keyPairAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *keyPairAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *keyPairAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KeyPairAttachment, err error) {
	result = &v1alpha1.KeyPairAttachment{}
