...
// SessionManagerStatusesGetter has a method to return a SessionManagerStatusInterface.
...
// sessionManagerStatuses implements SessionManagerStatusInterface
type sessionManagerStatuses struct {
	client rest.Interface
	ns     string
}

// newSessionManagerStatuses returns a SessionManagerStatuses
func newSessionManagerStatuses(c *EcsV1alpha1Client, namespace string) *sessionManagerStatuses {
	return &sessionManagerStatuses{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *sessionManagerStatuses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SessionManagerStatus, err error) {
	result = &v1alpha1.SessionManagerStatus{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *sessionManagerStatuses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SessionManagerStatusList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SessionManagerStatusList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sessionmanagerstatuses").
...
func (c *sessionManagerStatuses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sessionManagerStatuses) Create(ctx context.Context, sessionManagerStatus *v1alpha1.SessionManagerStatus, opts v1.CreateOptions) (result *v1alpha1.SessionManagerStatus, err error) {
	result = &v1alpha1.SessionManagerStatus{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sessionmanagerstatuses").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(sessionManagerStatus).
		Do(ctx).
		Into(result)
	return
}
...
func (c *sessionManagerStatuses) Update(ctx context.Context, sessionManagerStatus *v1alpha1.SessionManagerStatus, opts v1.UpdateOptions) (result *v1alpha1.SessionManagerStatus, err error) {
	result = &v1alpha1.SessionManagerStatus{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sessionmanagerstatuses").
		Name(sessionManagerStatus.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(sessionManagerStatus).
		Do(ctx).
		Into(result)
...
func (c *sessionManagerStatuses) UpdateStatus(ctx context.Context, sessionManagerStatus *v1alpha1.SessionManagerStatus, opts v1.UpdateOptions) (result *v1alpha1.SessionManagerStatus, err error) {
	result = &v1alpha1.SessionManagerStatus{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sessionmanagerstatuses").
...
func (c *sessionManagerStatuses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sessionManagerStatuses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sessionManagerStatuses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SessionManagerStatus, err error) {
	result = &v1alpha1.SessionManagerStatus{}
