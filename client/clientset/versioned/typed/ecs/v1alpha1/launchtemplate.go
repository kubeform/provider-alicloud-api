...
func newLaunchTemplates(c *EcsV1alpha1Client, namespace string) *launchTemplates {
...
func (c *launchTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LaunchTemplate, err error) {
...
func (c *launchTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LaunchTemplateList, err error) {
...
func (c *launchTemplates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *launchTemplates) Create(ctx context.Context, launchTemplate *v1alpha1.LaunchTemplate, opts v1.CreateOptions) (result *v1alpha1.LaunchTemplate, err error) {
	result = &v1alpha1.LaunchTemplate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("launchtemplates").
...
func (c *launchTemplates) Update(ctx context.Context, launchTemplate *v1alpha1.LaunchTemplate, opts v1.UpdateOptions) (result *v1alpha1.LaunchTemplate, err error) {
	result = &v1alpha1.LaunchTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("launchtemplates").
...
func (c *launchTemplates) UpdateStatus(ctx context.Context, launchTemplate *v1alpha1.LaunchTemplate, opts v1.UpdateOptions) (result *v1alpha1.LaunchTemplate, err error) {
	result = &v1alpha1.LaunchTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("launchtemplates").
...
func (c *launchTemplates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *launchTemplates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *launchTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LaunchTemplate, err error) {
	result = &v1alpha1.LaunchTemplate{}
