...
// DeploymentSetsGetter has a method to return a DeploymentSetInterface.
...
// deploymentSets implements DeploymentSetInterface
type deploymentSets struct {
	client rest.Interface
	ns     string
}

// newDeploymentSets returns a DeploymentSets
func newDeploymentSets(c *EcsV1alpha1Client, namespace string) *deploymentSets {
...
func (c *deploymentSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DeploymentSet, err error) {
	result = &v1alpha1.DeploymentSet{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *deploymentSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DeploymentSetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DeploymentSetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("deploymentsets").
...
func (c *deploymentSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *deploymentSets) Create(ctx context.Context, deploymentSet *v1alpha1.DeploymentSet, opts v1.CreateOptions) (result *v1alpha1.DeploymentSet, err error) {
	result = &v1alpha1.DeploymentSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("deploymentsets").
...
func (c *deploymentSets) Update(ctx context.Context, deploymentSet *v1alpha1.DeploymentSet, opts v1.UpdateOptions) (result *v1alpha1.DeploymentSet, err error) {
	result = &v1alpha1.DeploymentSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("deploymentsets").
		Name(deploymentSet.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(deploymentSet).
		Do(ctx).
		Into(result)
...
func (c *deploymentSets) UpdateStatus(ctx context.Context, deploymentSet *v1alpha1.DeploymentSet, opts v1.UpdateOptions) (result *v1alpha1.DeploymentSet, err error) {
	result = &v1alpha1.DeploymentSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("deploymentsets").
...
func (c *deploymentSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *deploymentSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *deploymentSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DeploymentSet, err error) {
	result = &v1alpha1.DeploymentSet{}
