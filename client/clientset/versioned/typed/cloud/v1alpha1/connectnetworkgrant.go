...
// ConnectNetworkGrantsGetter has a method to return a ConnectNetworkGrantInterface.
...
// connectNetworkGrants implements ConnectNetworkGrantInterface
type connectNetworkGrants struct {
	client rest.Interface
	ns     string
}

// newConnectNetworkGrants returns a ConnectNetworkGrants
func newConnectNetworkGrants(c *CloudV1alpha1Client, namespace string) *connectNetworkGrants {
	return &connectNetworkGrants{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *connectNetworkGrants) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ConnectNetworkGrant, err error) {
	result = &v1alpha1.ConnectNetworkGrant{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *connectNetworkGrants) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ConnectNetworkGrantList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ConnectNetworkGrantList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("connectnetworkgrants").
...
func (c *connectNetworkGrants) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *connectNetworkGrants) Create(ctx context.Context, connectNetworkGrant *v1alpha1.ConnectNetworkGrant, opts v1.CreateOptions) (result *v1alpha1.ConnectNetworkGrant, err error) {
	result = &v1alpha1.ConnectNetworkGrant{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("connectnetworkgrants").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(connectNetworkGrant).
		Do(ctx).
		Into(result)
	return
}
...
func (c *connectNetworkGrants) Update(ctx context.Context, connectNetworkGrant *v1alpha1.ConnectNetworkGrant, opts v1.UpdateOptions) (result *v1alpha1.ConnectNetworkGrant, err error) {
	result = &v1alpha1.ConnectNetworkGrant{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("connectnetworkgrants").
		Name(connectNetworkGrant.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(connectNetworkGrant).
		Do(ctx).
		Into(result)
...
func (c *connectNetworkGrants) UpdateStatus(ctx context.Context, connectNetworkGrant *v1alpha1.ConnectNetworkGrant, opts v1.UpdateOptions) (result *v1alpha1.ConnectNetworkGrant, err error) {
	result = &v1alpha1.ConnectNetworkGrant{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("connectnetworkgrants").
...
func (c *connectNetworkGrants) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *connectNetworkGrants) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *connectNetworkGrants) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ConnectNetworkGrant, err error) {
	result = &v1alpha1.ConnectNetworkGrant{}
