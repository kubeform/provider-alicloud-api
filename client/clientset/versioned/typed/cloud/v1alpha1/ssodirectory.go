...
// SsoDirectoriesGetter has a method to return a SsoDirectoryInterface.
...
// ssoDirectories implements SsoDirectoryInterface
type ssoDirectories struct {
	client rest.Interface
	ns     string
}

// newSsoDirectories returns a SsoDirectories
func newSsoDirectories(c *CloudV1alpha1Client, namespace string) *ssoDirectories {
...
func (c *ssoDirectories) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SsoDirectory, err error) {
	result = &v1alpha1.SsoDirectory{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *ssoDirectories) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SsoDirectoryList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SsoDirectoryList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ssodirectories").
...
func (c *ssoDirectories) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ssoDirectories) Create(ctx context.Context, ssoDirectory *v1alpha1.SsoDirectory, opts v1.CreateOptions) (result *v1alpha1.SsoDirectory, err error) {
	result = &v1alpha1.SsoDirectory{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ssodirectories").
...
func (c *ssoDirectories) Update(ctx context.Context, ssoDirectory *v1alpha1.SsoDirectory, opts v1.UpdateOptions) (result *v1alpha1.SsoDirectory, err error) {
	result = &v1alpha1.SsoDirectory{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssodirectories").
		Name(ssoDirectory.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ssoDirectory).
		Do(ctx).
		Into(result)
...
func (c *ssoDirectories) UpdateStatus(ctx context.Context, ssoDirectory *v1alpha1.SsoDirectory, opts v1.UpdateOptions) (result *v1alpha1.SsoDirectory, err error) {
	result = &v1alpha1.SsoDirectory{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssodirectories").
...
func (c *ssoDirectories) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ssoDirectories) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ssoDirectories) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SsoDirectory, err error) {
	result = &v1alpha1.SsoDirectory{}
