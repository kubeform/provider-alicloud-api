...
// SsoScimServerCredentialsGetter has a method to return a SsoScimServerCredentialInterface.
...
// ssoScimServerCredentials implements SsoScimServerCredentialInterface
type ssoScimServerCredentials struct {
	client rest.Interface
	ns     string
}

// newSsoScimServerCredentials returns a SsoScimServerCredentials
func newSsoScimServerCredentials(c *CloudV1alpha1Client, namespace string) *ssoScimServerCredentials {
	return &ssoScimServerCredentials{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *ssoScimServerCredentials) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SsoScimServerCredential, err error) {
	result = &v1alpha1.SsoScimServerCredential{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *ssoScimServerCredentials) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SsoScimServerCredentialList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SsoScimServerCredentialList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ssoscimservercredentials").
...
func (c *ssoScimServerCredentials) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ssoScimServerCredentials) Create(ctx context.Context, ssoScimServerCredential *v1alpha1.SsoScimServerCredential, opts v1.CreateOptions) (result *v1alpha1.SsoScimServerCredential, err error) {
	result = &v1alpha1.SsoScimServerCredential{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ssoscimservercredentials").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ssoScimServerCredential).
		Do(ctx).
		Into(result)
	return
}
...
func (c *ssoScimServerCredentials) Update(ctx context.Context, ssoScimServerCredential *v1alpha1.SsoScimServerCredential, opts v1.UpdateOptions) (result *v1alpha1.SsoScimServerCredential, err error) {
	result = &v1alpha1.SsoScimServerCredential{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssoscimservercredentials").
		Name(ssoScimServerCredential.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ssoScimServerCredential).
		Do(ctx).
		Into(result)
...
func (c *ssoScimServerCredentials) UpdateStatus(ctx context.Context, ssoScimServerCredential *v1alpha1.SsoScimServerCredential, opts v1.UpdateOptions) (result *v1alpha1.SsoScimServerCredential, err error) {
	result = &v1alpha1.SsoScimServerCredential{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ssoscimservercredentials").
...
func (c *ssoScimServerCredentials) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ssoScimServerCredentials) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ssoScimServerCredentials) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SsoScimServerCredential, err error) {
	result = &v1alpha1.SsoScimServerCredential{}
