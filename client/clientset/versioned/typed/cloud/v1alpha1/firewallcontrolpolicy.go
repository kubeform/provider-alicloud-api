...
// FirewallControlPoliciesGetter has a method to return a FirewallControlPolicyInterface.
...
// firewallControlPolicies implements FirewallControlPolicyInterface
type firewallControlPolicies struct {
	client rest.Interface
	ns     string
}

// newFirewallControlPolicies returns a FirewallControlPolicies
func newFirewallControlPolicies(c *CloudV1alpha1Client, namespace string) *firewallControlPolicies {
	return &firewallControlPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *firewallControlPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FirewallControlPolicy, err error) {
	result = &v1alpha1.FirewallControlPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *firewallControlPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FirewallControlPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FirewallControlPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("firewallcontrolpolicies").
...
func (c *firewallControlPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *firewallControlPolicies) Create(ctx context.Context, firewallControlPolicy *v1alpha1.FirewallControlPolicy, opts v1.CreateOptions) (result *v1alpha1.FirewallControlPolicy, err error) {
	result = &v1alpha1.FirewallControlPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("firewallcontrolpolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(firewallControlPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *firewallControlPolicies) Update(ctx context.Context, firewallControlPolicy *v1alpha1.FirewallControlPolicy, opts v1.UpdateOptions) (result *v1alpha1.FirewallControlPolicy, err error) {
	result = &v1alpha1.FirewallControlPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firewallcontrolpolicies").
		Name(firewallControlPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(firewallControlPolicy).
		Do(ctx).
		Into(result)
...
func (c *firewallControlPolicies) UpdateStatus(ctx context.Context, firewallControlPolicy *v1alpha1.FirewallControlPolicy, opts v1.UpdateOptions) (result *v1alpha1.FirewallControlPolicy, err error) {
	result = &v1alpha1.FirewallControlPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firewallcontrolpolicies").
...
func (c *firewallControlPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *firewallControlPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *firewallControlPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FirewallControlPolicy, err error) {
	result = &v1alpha1.FirewallControlPolicy{}
