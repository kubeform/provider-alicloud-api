...
import (
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/clientset/versioned/typed/security/v1alpha1"
...
func (c *FakeSecurityV1alpha1) GroupRules(namespace string) v1alpha1.GroupRuleInterface {
	return &FakeGroupRules{c, namespace}
}
