...
type FakeInstances struct {
	Fake *FakeHbaseV1alpha1
	ns   string
}

var instancesResource = schema.GroupVersionResource{Group: "hbase.alicloud.kubeform.com", Version: "v1alpha1", Resource: "instances"}

var instancesKind = schema.GroupVersionKind{Group: "hbase.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Instance"}
