...
// DataV1alpha1Client is used to interact with features provided by the data.alicloud.kubeform.com group.
type DataV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DataV1alpha1Client) WorksFolders(namespace string) WorksFolderInterface {
	return newWorksFolders(c, namespace)
}
