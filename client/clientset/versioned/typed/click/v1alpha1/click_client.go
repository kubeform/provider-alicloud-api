...
func (c *ClickV1alpha1Client) HouseDbClusters(namespace string) HouseDbClusterInterface {
	return newHouseDbClusters(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*ClickV1alpha1Client, error) {
	...
	return &ClickV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ClickV1alpha1Client for the given config and
...
func New(c rest.Interface) *ClickV1alpha1Client {
	return &ClickV1alpha1Client{c}
}
