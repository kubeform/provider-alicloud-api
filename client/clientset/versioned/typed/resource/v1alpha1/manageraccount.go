...
// ManagerAccountsGetter has a method to return a ManagerAccountInterface.
...
// managerAccounts implements ManagerAccountInterface
type managerAccounts struct {
	client rest.Interface
	ns     string
}

// newManagerAccounts returns a ManagerAccounts
func newManagerAccounts(c *ResourceV1alpha1Client, namespace string) *managerAccounts {
...
func (c *managerAccounts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ManagerAccount, err error) {
	result = &v1alpha1.ManagerAccount{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *managerAccounts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ManagerAccountList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ManagerAccountList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("manageraccounts").
...
func (c *managerAccounts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *managerAccounts) Create(ctx context.Context, managerAccount *v1alpha1.ManagerAccount, opts v1.CreateOptions) (result *v1alpha1.ManagerAccount, err error) {
	result = &v1alpha1.ManagerAccount{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("manageraccounts").
...
func (c *managerAccounts) Update(ctx context.Context, managerAccount *v1alpha1.ManagerAccount, opts v1.UpdateOptions) (result *v1alpha1.ManagerAccount, err error) {
	result = &v1alpha1.ManagerAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("manageraccounts").
...
func (c *managerAccounts) UpdateStatus(ctx context.Context, managerAccount *v1alpha1.ManagerAccount, opts v1.UpdateOptions) (result *v1alpha1.ManagerAccount, err error) {
	result = &v1alpha1.ManagerAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("manageraccounts").
...
func (c *managerAccounts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *managerAccounts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *managerAccounts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ManagerAccount, err error) {
	result = &v1alpha1.ManagerAccount{}
