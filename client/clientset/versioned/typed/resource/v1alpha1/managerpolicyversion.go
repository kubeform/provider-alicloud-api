...
// ManagerPolicyVersionsGetter has a method to return a ManagerPolicyVersionInterface.
...
// managerPolicyVersions implements ManagerPolicyVersionInterface
type managerPolicyVersions struct {
	client rest.Interface
	ns     string
}

// newManagerPolicyVersions returns a ManagerPolicyVersions
func newManagerPolicyVersions(c *ResourceV1alpha1Client, namespace string) *managerPolicyVersions {
	return &managerPolicyVersions{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *managerPolicyVersions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ManagerPolicyVersion, err error) {
	result = &v1alpha1.ManagerPolicyVersion{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *managerPolicyVersions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ManagerPolicyVersionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ManagerPolicyVersionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("managerpolicyversions").
...
func (c *managerPolicyVersions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *managerPolicyVersions) Create(ctx context.Context, managerPolicyVersion *v1alpha1.ManagerPolicyVersion, opts v1.CreateOptions) (result *v1alpha1.ManagerPolicyVersion, err error) {
	result = &v1alpha1.ManagerPolicyVersion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("managerpolicyversions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(managerPolicyVersion).
		Do(ctx).
		Into(result)
	return
}
...
func (c *managerPolicyVersions) Update(ctx context.Context, managerPolicyVersion *v1alpha1.ManagerPolicyVersion, opts v1.UpdateOptions) (result *v1alpha1.ManagerPolicyVersion, err error) {
	result = &v1alpha1.ManagerPolicyVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managerpolicyversions").
		Name(managerPolicyVersion.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(managerPolicyVersion).
		Do(ctx).
		Into(result)
...
func (c *managerPolicyVersions) UpdateStatus(ctx context.Context, managerPolicyVersion *v1alpha1.ManagerPolicyVersion, opts v1.UpdateOptions) (result *v1alpha1.ManagerPolicyVersion, err error) {
	result = &v1alpha1.ManagerPolicyVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managerpolicyversions").
...
func (c *managerPolicyVersions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *managerPolicyVersions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *managerPolicyVersions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ManagerPolicyVersion, err error) {
	result = &v1alpha1.ManagerPolicyVersion{}
