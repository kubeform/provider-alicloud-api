...
type SagV1alpha1Interface interface {
...
func (c *SagV1alpha1Client) SnatEntries(namespace string) SnatEntryInterface {
	return newSnatEntries(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*SagV1alpha1Client, error) {
	...
	return &SagV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SagV1alpha1Client for the given config and
...
func New(c rest.Interface) *SagV1alpha1Client {
	return &SagV1alpha1Client{c}
}
