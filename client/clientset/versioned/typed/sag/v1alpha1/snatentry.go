...
// SnatEntriesGetter has a method to return a SnatEntryInterface.
...
// snatEntries implements SnatEntryInterface
type snatEntries struct {
	client rest.Interface
	ns     string
}

// newSnatEntries returns a SnatEntries
func newSnatEntries(c *SagV1alpha1Client, namespace string) *snatEntries {
	return &snatEntries{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *snatEntries) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SnatEntry, err error) {
	result = &v1alpha1.SnatEntry{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *snatEntries) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SnatEntryList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SnatEntryList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("snatentries").
...
func (c *snatEntries) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *snatEntries) Create(ctx context.Context, snatEntry *v1alpha1.SnatEntry, opts v1.CreateOptions) (result *v1alpha1.SnatEntry, err error) {
	result = &v1alpha1.SnatEntry{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("snatentries").
...
func (c *snatEntries) Update(ctx context.Context, snatEntry *v1alpha1.SnatEntry, opts v1.UpdateOptions) (result *v1alpha1.SnatEntry, err error) {
	result = &v1alpha1.SnatEntry{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("snatentries").
...
func (c *snatEntries) UpdateStatus(ctx context.Context, snatEntry *v1alpha1.SnatEntry, opts v1.UpdateOptions) (result *v1alpha1.SnatEntry, err error) {
	result = &v1alpha1.SnatEntry{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("snatentries").
...
func (c *snatEntries) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *snatEntries) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *snatEntries) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SnatEntry, err error) {
	result = &v1alpha1.SnatEntry{}
