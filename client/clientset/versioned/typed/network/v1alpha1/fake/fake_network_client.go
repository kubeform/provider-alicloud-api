...
import (
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/clientset/versioned/typed/network/v1alpha1"
...
func (c *FakeNetworkV1alpha1) AclAttachments(namespace string) v1alpha1.AclAttachmentInterface {
	return &FakeAclAttachments{c, namespace}
}

func (c *FakeNetworkV1alpha1) AclEntrieses(namespace string) v1alpha1.AclEntriesInterface {
	return &FakeAclEntrieses{c, namespace}
}
