...
var aclsResource = schema.GroupVersionResource{Group: "network.alicloud.kubeform.com", Version: "v1alpha1", Resource: "acls"}

var aclsKind = schema.GroupVersionKind{Group: "network.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Acl"}
