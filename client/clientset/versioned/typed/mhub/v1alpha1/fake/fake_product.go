...
type FakeProducts struct {
	Fake *FakeMhubV1alpha1
	ns   string
}

var productsResource = schema.GroupVersionResource{Group: "mhub.alicloud.kubeform.com", Version: "v1alpha1", Resource: "products"}

var productsKind = schema.GroupVersionKind{Group: "mhub.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Product"}
