...
type FakeKeyPairs struct {
	Fake *FakeEnsV1alpha1
	ns   string
}

var keypairsResource = schema.GroupVersionResource{Group: "ens.alicloud.kubeform.com", Version: "v1alpha1", Resource: "keypairs"}

var keypairsKind = schema.GroupVersionKind{Group: "ens.alicloud.kubeform.com", Version: "v1alpha1", Kind: "KeyPair"}
