...
type PolardbV1alpha1Interface interface {
	RESTClient() rest.Interface
	AccountsGetter
	AccountPrivilegesGetter
	BackupPoliciesGetter
	ClustersGetter
	DatabasesGetter
	EndpointsGetter
	EndpointAddressesGetter
}
...
func (c *PolardbV1alpha1Client) AccountPrivileges(namespace string) AccountPrivilegeInterface {
	return newAccountPrivileges(c, namespace)
}
...
func (c *PolardbV1alpha1Client) EndpointAddresses(namespace string) EndpointAddressInterface {
	return newEndpointAddresses(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*PolardbV1alpha1Client, error) {
	...
	return &PolardbV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new PolardbV1alpha1Client for the given config and
...
func New(c rest.Interface) *PolardbV1alpha1Client {
	return &PolardbV1alpha1Client{c}
}
