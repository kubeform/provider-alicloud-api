...
func NewForConfig(c *rest.Config) (*EipV1alpha1Client, error) {
	...
	return &EipV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new EipV1alpha1Client for the given config and
...
func New(c rest.Interface) *EipV1alpha1Client {
	return &EipV1alpha1Client{c}
}
