...
func newEips(c *EipV1alpha1Client, namespace string) *eips {
	return &eips{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *eips) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Eip, err error) {
	result = &v1alpha1.Eip{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("eips").
...
func (c *eips) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EipList, err error) {
...
func (c *eips) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *eips) Create(ctx context.Context, eip *v1alpha1.Eip, opts v1.CreateOptions) (result *v1alpha1.Eip, err error) {
	result = &v1alpha1.Eip{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("eips").
...
func (c *eips) Update(ctx context.Context, eip *v1alpha1.Eip, opts v1.UpdateOptions) (result *v1alpha1.Eip, err error) {
	result = &v1alpha1.Eip{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eips").
...
func (c *eips) UpdateStatus(ctx context.Context, eip *v1alpha1.Eip, opts v1.UpdateOptions) (result *v1alpha1.Eip, err error) {
	result = &v1alpha1.Eip{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eips").
...
func (c *eips) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *eips) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *eips) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Eip, err error) {
	result = &v1alpha1.Eip{}
