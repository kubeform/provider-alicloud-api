...
import (
	...
	v1alpha1 "kubeform.dev/provider-alicloud-api/apis/eip/v1alpha1"
...
func newAssociations(c *EipV1alpha1Client, namespace string) *associations {
	return &associations{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *associations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Association, err error) {
...
func (c *associations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AssociationList, err error) {
...
func (c *associations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *associations) Create(ctx context.Context, association *v1alpha1.Association, opts v1.CreateOptions) (result *v1alpha1.Association, err error) {
	result = &v1alpha1.Association{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("associations").
...
func (c *associations) Update(ctx context.Context, association *v1alpha1.Association, opts v1.UpdateOptions) (result *v1alpha1.Association, err error) {
	result = &v1alpha1.Association{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("associations").
...
func (c *associations) UpdateStatus(ctx context.Context, association *v1alpha1.Association, opts v1.UpdateOptions) (result *v1alpha1.Association, err error) {
	result = &v1alpha1.Association{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("associations").
...
func (c *associations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *associations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *associations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Association, err error) {
	result = &v1alpha1.Association{}
