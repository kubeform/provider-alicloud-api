...
// KmsV1alpha1Client is used to interact with features provided by the kms.alicloud.kubeform.com group.
...
func (c *KmsV1alpha1Client) Ciphertexts(namespace string) CiphertextInterface {
	return newCiphertexts(c, namespace)
}
...
func (c *KmsV1alpha1Client) KeyVersions(namespace string) KeyVersionInterface {
	return newKeyVersions(c, namespace)
}

func (c *KmsV1alpha1Client) Secrets(namespace string) SecretInterface {
