...
type DdoscooV1alpha1Interface interface {
	RESTClient() rest.Interface
	DomainResourcesGetter
	InstancesGetter
	PortsGetter
	SchedulerRulesGetter
}
...
func (c *DdoscooV1alpha1Client) DomainResources(namespace string) DomainResourceInterface {
	return newDomainResources(c, namespace)
}
...
func (c *DdoscooV1alpha1Client) SchedulerRules(namespace string) SchedulerRuleInterface {
	return newSchedulerRules(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*DdoscooV1alpha1Client, error) {
	...
	return &DdoscooV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DdoscooV1alpha1Client for the given config and
...
func New(c rest.Interface) *DdoscooV1alpha1Client {
	return &DdoscooV1alpha1Client{c}
}
