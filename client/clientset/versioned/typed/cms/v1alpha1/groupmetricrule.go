...
// GroupMetricRulesGetter has a method to return a GroupMetricRuleInterface.
...
// groupMetricRules implements GroupMetricRuleInterface
type groupMetricRules struct {
	client rest.Interface
	ns     string
}

// newGroupMetricRules returns a GroupMetricRules
func newGroupMetricRules(c *CmsV1alpha1Client, namespace string) *groupMetricRules {
...
func (c *groupMetricRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GroupMetricRule, err error) {
	result = &v1alpha1.GroupMetricRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *groupMetricRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GroupMetricRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.GroupMetricRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("groupmetricrules").
...
func (c *groupMetricRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *groupMetricRules) Create(ctx context.Context, groupMetricRule *v1alpha1.GroupMetricRule, opts v1.CreateOptions) (result *v1alpha1.GroupMetricRule, err error) {
	result = &v1alpha1.GroupMetricRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("groupmetricrules").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(groupMetricRule).
		Do(ctx).
		Into(result)
	return
}
...
func (c *groupMetricRules) Update(ctx context.Context, groupMetricRule *v1alpha1.GroupMetricRule, opts v1.UpdateOptions) (result *v1alpha1.GroupMetricRule, err error) {
	result = &v1alpha1.GroupMetricRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("groupmetricrules").
		Name(groupMetricRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(groupMetricRule).
		Do(ctx).
		Into(result)
...
func (c *groupMetricRules) UpdateStatus(ctx context.Context, groupMetricRule *v1alpha1.GroupMetricRule, opts v1.UpdateOptions) (result *v1alpha1.GroupMetricRule, err error) {
	result = &v1alpha1.GroupMetricRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("groupmetricrules").
...
func (c *groupMetricRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *groupMetricRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *groupMetricRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GroupMetricRule, err error) {
	result = &v1alpha1.GroupMetricRule{}
