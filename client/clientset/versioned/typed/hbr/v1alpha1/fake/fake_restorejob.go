...
var restorejobsResource = schema.GroupVersionResource{Group: "hbr.alicloud.kubeform.com", Version: "v1alpha1", Resource: "restorejobs"}

var restorejobsKind = schema.GroupVersionKind{Group: "hbr.alicloud.kubeform.com", Version: "v1alpha1", Kind: "RestoreJob"}
...
func (c *FakeRestoreJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(restorejobsResource, c.ns, name), &v1alpha1.RestoreJob{})
