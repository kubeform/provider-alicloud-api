...
var vaultsResource = schema.GroupVersionResource{Group: "hbr.alicloud.kubeform.com", Version: "v1alpha1", Resource: "vaults"}

var vaultsKind = schema.GroupVersionKind{Group: "hbr.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Vault"}
...
func (c *FakeVaults) UpdateStatus(ctx context.Context, vault *v1alpha1.Vault, opts v1.UpdateOptions) (*v1alpha1.Vault, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(vaultsResource, "status", c.ns, vault), &v1alpha1.Vault{})
