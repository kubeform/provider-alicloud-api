...
func newVaults(c *HbrV1alpha1Client, namespace string) *vaults {
	return &vaults{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *vaults) UpdateStatus(ctx context.Context, vault *v1alpha1.Vault, opts v1.UpdateOptions) (result *v1alpha1.Vault, err error) {
	result = &v1alpha1.Vault{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vaults").
