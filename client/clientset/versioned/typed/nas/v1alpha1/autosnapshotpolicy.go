...
// AutoSnapshotPoliciesGetter has a method to return a AutoSnapshotPolicyInterface.
...
// autoSnapshotPolicies implements AutoSnapshotPolicyInterface
type autoSnapshotPolicies struct {
	client rest.Interface
	ns     string
}

// newAutoSnapshotPolicies returns a AutoSnapshotPolicies
func newAutoSnapshotPolicies(c *NasV1alpha1Client, namespace string) *autoSnapshotPolicies {
...
func (c *autoSnapshotPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutoSnapshotPolicy, err error) {
	result = &v1alpha1.AutoSnapshotPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *autoSnapshotPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutoSnapshotPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AutoSnapshotPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("autosnapshotpolicies").
...
func (c *autoSnapshotPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *autoSnapshotPolicies) Create(ctx context.Context, autoSnapshotPolicy *v1alpha1.AutoSnapshotPolicy, opts v1.CreateOptions) (result *v1alpha1.AutoSnapshotPolicy, err error) {
	result = &v1alpha1.AutoSnapshotPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("autosnapshotpolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(autoSnapshotPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *autoSnapshotPolicies) Update(ctx context.Context, autoSnapshotPolicy *v1alpha1.AutoSnapshotPolicy, opts v1.UpdateOptions) (result *v1alpha1.AutoSnapshotPolicy, err error) {
	result = &v1alpha1.AutoSnapshotPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("autosnapshotpolicies").
		Name(autoSnapshotPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(autoSnapshotPolicy).
		Do(ctx).
		Into(result)
...
func (c *autoSnapshotPolicies) UpdateStatus(ctx context.Context, autoSnapshotPolicy *v1alpha1.AutoSnapshotPolicy, opts v1.UpdateOptions) (result *v1alpha1.AutoSnapshotPolicy, err error) {
	result = &v1alpha1.AutoSnapshotPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("autosnapshotpolicies").
...
func (c *autoSnapshotPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *autoSnapshotPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *autoSnapshotPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutoSnapshotPolicy, err error) {
	result = &v1alpha1.AutoSnapshotPolicy{}
