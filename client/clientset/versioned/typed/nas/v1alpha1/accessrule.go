...
// AccessRulesGetter has a method to return a AccessRuleInterface.
...
// accessRules implements AccessRuleInterface
type accessRules struct {
	client rest.Interface
	ns     string
}

// newAccessRules returns a AccessRules
func newAccessRules(c *NasV1alpha1Client, namespace string) *accessRules {
	return &accessRules{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *accessRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AccessRule, err error) {
	result = &v1alpha1.AccessRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *accessRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AccessRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AccessRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("accessrules").
...
func (c *accessRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *accessRules) Create(ctx context.Context, accessRule *v1alpha1.AccessRule, opts v1.CreateOptions) (result *v1alpha1.AccessRule, err error) {
	result = &v1alpha1.AccessRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("accessrules").
...
func (c *accessRules) Update(ctx context.Context, accessRule *v1alpha1.AccessRule, opts v1.UpdateOptions) (result *v1alpha1.AccessRule, err error) {
	result = &v1alpha1.AccessRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accessrules").
...
func (c *accessRules) UpdateStatus(ctx context.Context, accessRule *v1alpha1.AccessRule, opts v1.UpdateOptions) (result *v1alpha1.AccessRule, err error) {
	result = &v1alpha1.AccessRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accessrules").
...
func (c *accessRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *accessRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *accessRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AccessRule, err error) {
	result = &v1alpha1.AccessRule{}
