...
// AccessGroupsGetter has a method to return a AccessGroupInterface.
...
// accessGroups implements AccessGroupInterface
type accessGroups struct {
	client rest.Interface
	ns     string
}

// newAccessGroups returns a AccessGroups
func newAccessGroups(c *NasV1alpha1Client, namespace string) *accessGroups {
	return &accessGroups{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *accessGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AccessGroup, err error) {
	result = &v1alpha1.AccessGroup{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *accessGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AccessGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AccessGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("accessgroups").
...
func (c *accessGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *accessGroups) Create(ctx context.Context, accessGroup *v1alpha1.AccessGroup, opts v1.CreateOptions) (result *v1alpha1.AccessGroup, err error) {
	result = &v1alpha1.AccessGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("accessgroups").
...
func (c *accessGroups) Update(ctx context.Context, accessGroup *v1alpha1.AccessGroup, opts v1.UpdateOptions) (result *v1alpha1.AccessGroup, err error) {
	result = &v1alpha1.AccessGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accessgroups").
...
func (c *accessGroups) UpdateStatus(ctx context.Context, accessGroup *v1alpha1.AccessGroup, opts v1.UpdateOptions) (result *v1alpha1.AccessGroup, err error) {
	result = &v1alpha1.AccessGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accessgroups").
...
func (c *accessGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *accessGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *accessGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AccessGroup, err error) {
	result = &v1alpha1.AccessGroup{}
