...
var filesystemsResource = schema.GroupVersionResource{Group: "nas.alicloud.kubeform.com", Version: "v1alpha1", Resource: "filesystems"}

var filesystemsKind = schema.GroupVersionKind{Group: "nas.alicloud.kubeform.com", Version: "v1alpha1", Kind: "FileSystem"}
...
func (c *FakeFileSystems) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeFileSystems) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(filesystemsResource, c.ns, listOpts)
