...
// MailTagsGetter has a method to return a MailTagInterface.
...
// mailTags implements MailTagInterface
type mailTags struct {
	client rest.Interface
	ns     string
}

// newMailTags returns a MailTags
func newMailTags(c *DirectV1alpha1Client, namespace string) *mailTags {
	return &mailTags{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *mailTags) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MailTag, err error) {
	result = &v1alpha1.MailTag{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mailtags").
		Name(name).
...
func (c *mailTags) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MailTagList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MailTagList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mailtags").
...
func (c *mailTags) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mailTags) Create(ctx context.Context, mailTag *v1alpha1.MailTag, opts v1.CreateOptions) (result *v1alpha1.MailTag, err error) {
	result = &v1alpha1.MailTag{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mailtags").
...
func (c *mailTags) Update(ctx context.Context, mailTag *v1alpha1.MailTag, opts v1.UpdateOptions) (result *v1alpha1.MailTag, err error) {
	result = &v1alpha1.MailTag{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mailtags").
...
func (c *mailTags) UpdateStatus(ctx context.Context, mailTag *v1alpha1.MailTag, opts v1.UpdateOptions) (result *v1alpha1.MailTag, err error) {
	result = &v1alpha1.MailTag{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mailtags").
...
func (c *mailTags) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mailTags) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mailTags) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MailTag, err error) {
	result = &v1alpha1.MailTag{}
