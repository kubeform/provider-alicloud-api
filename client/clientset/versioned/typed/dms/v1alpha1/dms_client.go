...
type DmsV1alpha1Interface interface {
	...
	EnterpriseInstancesGetter
	EnterpriseUsersGetter
}

// DmsV1alpha1Client is used to interact with features provided by the dms.alicloud.kubeform.com group.
type DmsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DmsV1alpha1Client) EnterpriseInstances(namespace string) EnterpriseInstanceInterface {
	return newEnterpriseInstances(c, namespace)
}

func (c *DmsV1alpha1Client) EnterpriseUsers(namespace string) EnterpriseUserInterface {
	return newEnterpriseUsers(c, namespace)
}
