...
// ProtectionModulesGetter has a method to return a ProtectionModuleInterface.
...
// protectionModules implements ProtectionModuleInterface
type protectionModules struct {
	client rest.Interface
	ns     string
}

// newProtectionModules returns a ProtectionModules
func newProtectionModules(c *WafV1alpha1Client, namespace string) *protectionModules {
	return &protectionModules{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *protectionModules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProtectionModule, err error) {
	result = &v1alpha1.ProtectionModule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *protectionModules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProtectionModuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProtectionModuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("protectionmodules").
...
func (c *protectionModules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *protectionModules) Create(ctx context.Context, protectionModule *v1alpha1.ProtectionModule, opts v1.CreateOptions) (result *v1alpha1.ProtectionModule, err error) {
	result = &v1alpha1.ProtectionModule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("protectionmodules").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(protectionModule).
		Do(ctx).
		Into(result)
	return
}
...
func (c *protectionModules) Update(ctx context.Context, protectionModule *v1alpha1.ProtectionModule, opts v1.UpdateOptions) (result *v1alpha1.ProtectionModule, err error) {
	result = &v1alpha1.ProtectionModule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("protectionmodules").
		Name(protectionModule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(protectionModule).
		Do(ctx).
		Into(result)
...
func (c *protectionModules) UpdateStatus(ctx context.Context, protectionModule *v1alpha1.ProtectionModule, opts v1.UpdateOptions) (result *v1alpha1.ProtectionModule, err error) {
	result = &v1alpha1.ProtectionModule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("protectionmodules").
...
func (c *protectionModules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *protectionModules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *protectionModules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProtectionModule, err error) {
	result = &v1alpha1.ProtectionModule{}
