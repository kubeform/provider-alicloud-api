...
import (
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/clientset/versioned/typed/waf/v1alpha1"
...
func (c *FakeWafV1alpha1) Instances(namespace string) v1alpha1.InstanceInterface {
