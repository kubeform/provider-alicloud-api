...
// AlertContactsGetter has a method to return a AlertContactInterface.
...
// alertContacts implements AlertContactInterface
type alertContacts struct {
	client rest.Interface
	ns     string
}

// newAlertContacts returns a AlertContacts
func newAlertContacts(c *ArmsV1alpha1Client, namespace string) *alertContacts {
...
func (c *alertContacts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AlertContact, err error) {
	result = &v1alpha1.AlertContact{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *alertContacts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AlertContactList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AlertContactList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("alertcontacts").
...
func (c *alertContacts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *alertContacts) Create(ctx context.Context, alertContact *v1alpha1.AlertContact, opts v1.CreateOptions) (result *v1alpha1.AlertContact, err error) {
	result = &v1alpha1.AlertContact{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("alertcontacts").
...
func (c *alertContacts) Update(ctx context.Context, alertContact *v1alpha1.AlertContact, opts v1.UpdateOptions) (result *v1alpha1.AlertContact, err error) {
	result = &v1alpha1.AlertContact{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alertcontacts").
		Name(alertContact.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(alertContact).
		Do(ctx).
		Into(result)
...
func (c *alertContacts) UpdateStatus(ctx context.Context, alertContact *v1alpha1.AlertContact, opts v1.UpdateOptions) (result *v1alpha1.AlertContact, err error) {
	result = &v1alpha1.AlertContact{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alertcontacts").
...
func (c *alertContacts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *alertContacts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *alertContacts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AlertContact, err error) {
	result = &v1alpha1.AlertContact{}
