...
type ArmsV1alpha1Interface interface {
	RESTClient() rest.Interface
	AlertContactsGetter
	AlertContactGroupsGetter
	DispatchRulesGetter
	PrometheusAlertRulesGetter
}
...
func NewForConfig(c *rest.Config) (*ArmsV1alpha1Client, error) {
	...
	return &ArmsV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ArmsV1alpha1Client for the given config and
...
func New(c rest.Interface) *ArmsV1alpha1Client {
	return &ArmsV1alpha1Client{c}
}
