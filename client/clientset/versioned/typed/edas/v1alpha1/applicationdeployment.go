...
// ApplicationDeploymentsGetter has a method to return a ApplicationDeploymentInterface.
...
// applicationDeployments implements ApplicationDeploymentInterface
type applicationDeployments struct {
	client rest.Interface
	ns     string
}

// newApplicationDeployments returns a ApplicationDeployments
func newApplicationDeployments(c *EdasV1alpha1Client, namespace string) *applicationDeployments {
...
func (c *applicationDeployments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApplicationDeployment, err error) {
	result = &v1alpha1.ApplicationDeployment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *applicationDeployments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApplicationDeploymentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApplicationDeploymentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("applicationdeployments").
...
func (c *applicationDeployments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *applicationDeployments) Create(ctx context.Context, applicationDeployment *v1alpha1.ApplicationDeployment, opts v1.CreateOptions) (result *v1alpha1.ApplicationDeployment, err error) {
	result = &v1alpha1.ApplicationDeployment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("applicationdeployments").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(applicationDeployment).
		Do(ctx).
		Into(result)
	return
}
...
func (c *applicationDeployments) Update(ctx context.Context, applicationDeployment *v1alpha1.ApplicationDeployment, opts v1.UpdateOptions) (result *v1alpha1.ApplicationDeployment, err error) {
	result = &v1alpha1.ApplicationDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applicationdeployments").
		Name(applicationDeployment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(applicationDeployment).
		Do(ctx).
		Into(result)
...
func (c *applicationDeployments) UpdateStatus(ctx context.Context, applicationDeployment *v1alpha1.ApplicationDeployment, opts v1.UpdateOptions) (result *v1alpha1.ApplicationDeployment, err error) {
	result = &v1alpha1.ApplicationDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applicationdeployments").
...
func (c *applicationDeployments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *applicationDeployments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *applicationDeployments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApplicationDeployment, err error) {
	result = &v1alpha1.ApplicationDeployment{}
