...
type DcdnV1alpha1Client struct {
	restClient rest.Interface
}
...
func (c *DcdnV1alpha1Client) IpaDomains(namespace string) IpaDomainInterface {
	return newIpaDomains(c, namespace)
}

// NewForConfig creates a new DcdnV1alpha1Client for the given config.
func NewForConfig(c *rest.Config) (*DcdnV1alpha1Client, error) {
	config := *c
	...
	return &DcdnV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DcdnV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *DcdnV1alpha1Client {
...
// New creates a new DcdnV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *DcdnV1alpha1Client {
	return &DcdnV1alpha1Client{c}
}
...
func (c *DcdnV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
