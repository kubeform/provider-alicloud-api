...
type BrainV1alpha1Interface interface {
	RESTClient() rest.Interface
	IndustrialPidLoopsGetter
	IndustrialPidOrganizationsGetter
	IndustrialPidProjectsGetter
}
...
func NewForConfig(c *rest.Config) (*BrainV1alpha1Client, error) {
	...
	return &BrainV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new BrainV1alpha1Client for the given config and
...
func New(c rest.Interface) *BrainV1alpha1Client {
	return &BrainV1alpha1Client{c}
}
