...
// ZoneRecordsGetter has a method to return a ZoneRecordInterface.
...
// zoneRecords implements ZoneRecordInterface
type zoneRecords struct {
	client rest.Interface
	ns     string
}

// newZoneRecords returns a ZoneRecords
func newZoneRecords(c *PvtzV1alpha1Client, namespace string) *zoneRecords {
	return &zoneRecords{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *zoneRecords) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ZoneRecord, err error) {
	result = &v1alpha1.ZoneRecord{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *zoneRecords) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ZoneRecordList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ZoneRecordList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("zonerecords").
...
func (c *zoneRecords) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *zoneRecords) Create(ctx context.Context, zoneRecord *v1alpha1.ZoneRecord, opts v1.CreateOptions) (result *v1alpha1.ZoneRecord, err error) {
	result = &v1alpha1.ZoneRecord{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("zonerecords").
...
func (c *zoneRecords) Update(ctx context.Context, zoneRecord *v1alpha1.ZoneRecord, opts v1.UpdateOptions) (result *v1alpha1.ZoneRecord, err error) {
	result = &v1alpha1.ZoneRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("zonerecords").
...
func (c *zoneRecords) UpdateStatus(ctx context.Context, zoneRecord *v1alpha1.ZoneRecord, opts v1.UpdateOptions) (result *v1alpha1.ZoneRecord, err error) {
	result = &v1alpha1.ZoneRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("zonerecords").
...
func (c *zoneRecords) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *zoneRecords) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *zoneRecords) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ZoneRecord, err error) {
	result = &v1alpha1.ZoneRecord{}
