...
var rulesResource = schema.GroupVersionResource{Group: "pvtz.alicloud.kubeform.com", Version: "v1alpha1", Resource: "rules"}

var rulesKind = schema.GroupVersionKind{Group: "pvtz.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Rule"}
...
func (c *FakeRules) UpdateStatus(ctx context.Context, rule *v1alpha1.Rule, opts v1.UpdateOptions) (*v1alpha1.Rule, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(rulesResource, "status", c.ns, rule), &v1alpha1.Rule{})
