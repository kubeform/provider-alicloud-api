...
func newCustomerGateways(c *VpnV1alpha1Client, namespace string) *customerGateways {
...
func (c *customerGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CustomerGateway, err error) {
...
func (c *customerGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CustomerGatewayList, err error) {
...
func (c *customerGateways) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *customerGateways) Create(ctx context.Context, customerGateway *v1alpha1.CustomerGateway, opts v1.CreateOptions) (result *v1alpha1.CustomerGateway, err error) {
	result = &v1alpha1.CustomerGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("customergateways").
...
func (c *customerGateways) Update(ctx context.Context, customerGateway *v1alpha1.CustomerGateway, opts v1.UpdateOptions) (result *v1alpha1.CustomerGateway, err error) {
	result = &v1alpha1.CustomerGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customergateways").
...
func (c *customerGateways) UpdateStatus(ctx context.Context, customerGateway *v1alpha1.CustomerGateway, opts v1.UpdateOptions) (result *v1alpha1.CustomerGateway, err error) {
	result = &v1alpha1.CustomerGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customergateways").
...
func (c *customerGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *customerGateways) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *customerGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CustomerGateway, err error) {
	result = &v1alpha1.CustomerGateway{}
