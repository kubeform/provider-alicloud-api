...
// VpnV1alpha1Client is used to interact with features provided by the vpn.alicloud.kubeform.com group.
type VpnV1alpha1Client struct {
	restClient rest.Interface
}

func (c *VpnV1alpha1Client) Connections(namespace string) ConnectionInterface {
	return newConnections(c, namespace)
}

func (c *VpnV1alpha1Client) CustomerGateways(namespace string) CustomerGatewayInterface {
	return newCustomerGateways(c, namespace)
}

func (c *VpnV1alpha1Client) Gateways(namespace string) GatewayInterface {
	return newGateways(c, namespace)
}

func (c *VpnV1alpha1Client) RouteEntries(namespace string) RouteEntryInterface {
