...
var backuppoliciesResource = schema.GroupVersionResource{Group: "kvstore.alicloud.kubeform.com", Version: "v1alpha1", Resource: "backuppolicies"}

var backuppoliciesKind = schema.GroupVersionKind{Group: "kvstore.alicloud.kubeform.com", Version: "v1alpha1", Kind: "BackupPolicy"}
...
func (c *FakeBackupPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(backuppoliciesResource, c.ns, name), &v1alpha1.BackupPolicy{})
