...
type FakeClusters struct {
	Fake *FakeMseV1alpha1
	ns   string
}

var clustersResource = schema.GroupVersionResource{Group: "mse.alicloud.kubeform.com", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "mse.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Cluster"}
