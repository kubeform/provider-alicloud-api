...
func newRecords(c *AlidnsV1alpha1Client, namespace string) *records {
	return &records{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *records) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Record, err error) {
...
func (c *records) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RecordList, err error) {
...
func (c *records) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *records) Create(ctx context.Context, record *v1alpha1.Record, opts v1.CreateOptions) (result *v1alpha1.Record, err error) {
	result = &v1alpha1.Record{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("records").
...
func (c *records) Update(ctx context.Context, record *v1alpha1.Record, opts v1.UpdateOptions) (result *v1alpha1.Record, err error) {
	result = &v1alpha1.Record{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("records").
...
func (c *records) UpdateStatus(ctx context.Context, record *v1alpha1.Record, opts v1.UpdateOptions) (result *v1alpha1.Record, err error) {
	result = &v1alpha1.Record{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("records").
...
func (c *records) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *records) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *records) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Record, err error) {
	result = &v1alpha1.Record{}
