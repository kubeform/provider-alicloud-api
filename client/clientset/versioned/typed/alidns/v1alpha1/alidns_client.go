...
func NewForConfig(c *rest.Config) (*AlidnsV1alpha1Client, error) {
	...
	return &AlidnsV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AlidnsV1alpha1Client for the given config and
...
func New(c rest.Interface) *AlidnsV1alpha1Client {
	return &AlidnsV1alpha1Client{c}
}
