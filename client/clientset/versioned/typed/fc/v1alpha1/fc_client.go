...
type FcV1alpha1Interface interface {
	RESTClient() rest.Interface
	AliasesGetter
	CustomDomainsGetter
	FunctionsGetter
	FunctionAsyncInvokeConfigsGetter
	ServicesGetter
	TriggersGetter
}
...
func (c *FcV1alpha1Client) FunctionAsyncInvokeConfigs(namespace string) FunctionAsyncInvokeConfigInterface {
	return newFunctionAsyncInvokeConfigs(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*FcV1alpha1Client, error) {
	...
	return &FcV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new FcV1alpha1Client for the given config and
...
func New(c rest.Interface) *FcV1alpha1Client {
	return &FcV1alpha1Client{c}
}
