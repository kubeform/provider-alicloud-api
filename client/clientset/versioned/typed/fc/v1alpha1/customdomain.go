...
// CustomDomainsGetter has a method to return a CustomDomainInterface.
...
// customDomains implements CustomDomainInterface
type customDomains struct {
	client rest.Interface
	ns     string
}

// newCustomDomains returns a CustomDomains
func newCustomDomains(c *FcV1alpha1Client, namespace string) *customDomains {
...
func (c *customDomains) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CustomDomain, err error) {
	result = &v1alpha1.CustomDomain{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *customDomains) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CustomDomainList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CustomDomainList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("customdomains").
...
func (c *customDomains) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *customDomains) Create(ctx context.Context, customDomain *v1alpha1.CustomDomain, opts v1.CreateOptions) (result *v1alpha1.CustomDomain, err error) {
	result = &v1alpha1.CustomDomain{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("customdomains").
...
func (c *customDomains) Update(ctx context.Context, customDomain *v1alpha1.CustomDomain, opts v1.UpdateOptions) (result *v1alpha1.CustomDomain, err error) {
	result = &v1alpha1.CustomDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customdomains").
...
func (c *customDomains) UpdateStatus(ctx context.Context, customDomain *v1alpha1.CustomDomain, opts v1.UpdateOptions) (result *v1alpha1.CustomDomain, err error) {
	result = &v1alpha1.CustomDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customdomains").
...
func (c *customDomains) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *customDomains) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *customDomains) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CustomDomain, err error) {
	result = &v1alpha1.CustomDomain{}
