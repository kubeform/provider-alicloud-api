...
// SnatV1alpha1Client is used to interact with features provided by the snat.alicloud.kubeform.com group.
type SnatV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SnatV1alpha1Client) Entries(namespace string) EntryInterface {
