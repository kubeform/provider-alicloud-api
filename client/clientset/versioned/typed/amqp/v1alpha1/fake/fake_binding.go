...
var bindingsResource = schema.GroupVersionResource{Group: "amqp.alicloud.kubeform.com", Version: "v1alpha1", Resource: "bindings"}

var bindingsKind = schema.GroupVersionKind{Group: "amqp.alicloud.kubeform.com", Version: "v1alpha1", Kind: "Binding"}
