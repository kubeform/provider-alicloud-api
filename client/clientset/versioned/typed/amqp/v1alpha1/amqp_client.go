...
func NewForConfig(c *rest.Config) (*AmqpV1alpha1Client, error) {
	...
	return &AmqpV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AmqpV1alpha1Client for the given config and
...
func New(c rest.Interface) *AmqpV1alpha1Client {
	return &AmqpV1alpha1Client{c}
}
