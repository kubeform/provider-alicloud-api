...
func newVirtualHosts(c *AmqpV1alpha1Client, namespace string) *virtualHosts {
	return &virtualHosts{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *virtualHosts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VirtualHost, err error) {
...
func (c *virtualHosts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VirtualHostList, err error) {
...
func (c *virtualHosts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *virtualHosts) Create(ctx context.Context, virtualHost *v1alpha1.VirtualHost, opts v1.CreateOptions) (result *v1alpha1.VirtualHost, err error) {
	result = &v1alpha1.VirtualHost{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("virtualhosts").
...
func (c *virtualHosts) Update(ctx context.Context, virtualHost *v1alpha1.VirtualHost, opts v1.UpdateOptions) (result *v1alpha1.VirtualHost, err error) {
	result = &v1alpha1.VirtualHost{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualhosts").
...
func (c *virtualHosts) UpdateStatus(ctx context.Context, virtualHost *v1alpha1.VirtualHost, opts v1.UpdateOptions) (result *v1alpha1.VirtualHost, err error) {
	result = &v1alpha1.VirtualHost{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualhosts").
...
func (c *virtualHosts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *virtualHosts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *virtualHosts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VirtualHost, err error) {
	result = &v1alpha1.VirtualHost{}
