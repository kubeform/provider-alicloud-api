...
func newExchanges(c *AmqpV1alpha1Client, namespace string) *exchanges {
	return &exchanges{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *exchanges) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Exchange, err error) {
	result = &v1alpha1.Exchange{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("exchanges").
		Name(name).
...
func (c *exchanges) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ExchangeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ExchangeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("exchanges").
...
func (c *exchanges) Create(ctx context.Context, exchange *v1alpha1.Exchange, opts v1.CreateOptions) (result *v1alpha1.Exchange, err error) {
	result = &v1alpha1.Exchange{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("exchanges").
...
func (c *exchanges) Update(ctx context.Context, exchange *v1alpha1.Exchange, opts v1.UpdateOptions) (result *v1alpha1.Exchange, err error) {
	result = &v1alpha1.Exchange{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("exchanges").
...
func (c *exchanges) UpdateStatus(ctx context.Context, exchange *v1alpha1.Exchange, opts v1.UpdateOptions) (result *v1alpha1.Exchange, err error) {
	result = &v1alpha1.Exchange{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("exchanges").
...
func (c *exchanges) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Exchange, err error) {
	result = &v1alpha1.Exchange{}
