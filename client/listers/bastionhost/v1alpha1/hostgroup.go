...
// List lists all HostGroups in the indexer.
func (s *hostGroupLister) List(selector labels.Selector) (ret []*v1alpha1.HostGroup, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.HostGroup))
	})
	return ret, err
}
...
// List lists all HostGroups in the indexer for a given namespace.
func (s hostGroupNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.HostGroup, err error) {
...
// Get retrieves the HostGroup from the indexer for a given namespace and name.
func (s hostGroupNamespaceLister) Get(name string) (*v1alpha1.HostGroup, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("hostgroup"), name)
	}
	return obj.(*v1alpha1.HostGroup), nil
}
