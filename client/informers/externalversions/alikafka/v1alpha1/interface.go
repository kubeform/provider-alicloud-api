...
// SaslACLs returns a SaslACLInformer.
func (v *version) SaslACLs() SaslACLInformer {
	return &saslACLInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// SaslUsers returns a SaslUserInformer.
func (v *version) SaslUsers() SaslUserInformer {
	return &saslUserInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
