	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NasV1alpha1().MountTargets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NasV1alpha1().MountTargets(namespace).Watch(context.TODO(), options)
			},
		},
		&nasv1alpha1.MountTarget{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mountTargetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nasv1alpha1.MountTarget{}, f.defaultInformer)
}
