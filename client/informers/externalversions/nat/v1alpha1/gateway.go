...
import (
	...
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/listers/nat/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NatV1alpha1().Gateways(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NatV1alpha1().Gateways(namespace).Watch(context.TODO(), options)
			},
		},
		&natv1alpha1.Gateway{},
		resyncPeriod,
...
func (f *gatewayInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&natv1alpha1.Gateway{}, f.defaultInformer)
}
