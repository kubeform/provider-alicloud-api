	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OnsV1alpha1().Groups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OnsV1alpha1().Groups(namespace).Watch(context.TODO(), options)
			},
		},
		&onsv1alpha1.Group{},
		resyncPeriod,
...
func (f *groupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&onsv1alpha1.Group{}, f.defaultInformer)
}
