	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AdbV1alpha1().Connections(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AdbV1alpha1().Connections(namespace).Watch(context.TODO(), options)
			},
		},
		&adbv1alpha1.Connection{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *connectionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&adbv1alpha1.Connection{}, f.defaultInformer)
}
