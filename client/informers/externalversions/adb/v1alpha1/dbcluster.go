	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AdbV1alpha1().DbClusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AdbV1alpha1().DbClusters(namespace).Watch(context.TODO(), options)
			},
		},
		&adbv1alpha1.DbCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *dbClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&adbv1alpha1.DbCluster{}, f.defaultInformer)
}
