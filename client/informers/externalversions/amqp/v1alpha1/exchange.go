...
import (
	...
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/listers/amqp/v1alpha1"
...
type ExchangeInformer interface {
	...
	Lister() v1alpha1.ExchangeLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AmqpV1alpha1().Exchanges(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AmqpV1alpha1().Exchanges(namespace).Watch(context.TODO(), options)
			},
		},
		&amqpv1alpha1.Exchange{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *exchangeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&amqpv1alpha1.Exchange{}, f.defaultInformer)
}

func (f *exchangeInformer) Lister() v1alpha1.ExchangeLister {
	return v1alpha1.NewExchangeLister(f.Informer().GetIndexer())
}
