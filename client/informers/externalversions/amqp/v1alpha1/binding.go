	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AmqpV1alpha1().Bindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AmqpV1alpha1().Bindings(namespace).Watch(context.TODO(), options)
			},
		},
		&amqpv1alpha1.Binding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *bindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&amqpv1alpha1.Binding{}, f.defaultInformer)
}
