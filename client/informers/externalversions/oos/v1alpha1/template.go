	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OosV1alpha1().Templates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OosV1alpha1().Templates(namespace).Watch(context.TODO(), options)
			},
		},
		&oosv1alpha1.Template{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *templateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&oosv1alpha1.Template{}, f.defaultInformer)
}
