	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MnsV1alpha1().Queues(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MnsV1alpha1().Queues(namespace).Watch(context.TODO(), options)
			},
		},
		&mnsv1alpha1.Queue{},
		resyncPeriod,
...
func (f *queueInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mnsv1alpha1.Queue{}, f.defaultInformer)
}
