	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MnsV1alpha1().Topics(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MnsV1alpha1().Topics(namespace).Watch(context.TODO(), options)
			},
		},
		&mnsv1alpha1.Topic{},
		resyncPeriod,
...
func (f *topicInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mnsv1alpha1.Topic{}, f.defaultInformer)
}
