	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CenV1alpha1().Flowlogs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CenV1alpha1().Flowlogs(namespace).Watch(context.TODO(), options)
			},
		},
		&cenv1alpha1.Flowlog{},
		resyncPeriod,
...
func (f *flowlogInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cenv1alpha1.Flowlog{}, f.defaultInformer)
}
