	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SagV1alpha1().Acls(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SagV1alpha1().Acls(namespace).Watch(context.TODO(), options)
			},
		},
		&sagv1alpha1.Acl{},
		resyncPeriod,
...
func (f *aclInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sagv1alpha1.Acl{}, f.defaultInformer)
}
