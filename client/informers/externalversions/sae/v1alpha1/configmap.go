...
type ConfigMapInformer interface {
	...
	Lister() v1alpha1.ConfigMapLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SaeV1alpha1().ConfigMaps(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SaeV1alpha1().ConfigMaps(namespace).Watch(context.TODO(), options)
			},
		},
		&saev1alpha1.ConfigMap{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *configMapInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&saev1alpha1.ConfigMap{}, f.defaultInformer)
}

func (f *configMapInformer) Lister() v1alpha1.ConfigMapLister {
	return v1alpha1.NewConfigMapLister(f.Informer().GetIndexer())
}
