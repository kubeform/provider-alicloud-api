...
import (
	...
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/listers/subnet/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SubnetV1alpha1().Subnets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SubnetV1alpha1().Subnets(namespace).Watch(context.TODO(), options)
			},
		},
		&subnetv1alpha1.Subnet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *subnetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&subnetv1alpha1.Subnet{}, f.defaultInformer)
}
