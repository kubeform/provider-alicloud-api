	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KmsV1alpha1().Secrets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KmsV1alpha1().Secrets(namespace).Watch(context.TODO(), options)
			},
		},
		&kmsv1alpha1.Secret{},
		resyncPeriod,
...
func (f *secretInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kmsv1alpha1.Secret{}, f.defaultInformer)
}
