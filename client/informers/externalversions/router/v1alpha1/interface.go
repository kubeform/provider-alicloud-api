...
type Interface interface {
	...
	// InterfaceConnections returns a InterfaceConnectionInformer.
	InterfaceConnections() InterfaceConnectionInformer
}
...
// InterfaceConnections returns a InterfaceConnectionInformer.
func (v *version) InterfaceConnections() InterfaceConnectionInformer {
	return &interfaceConnectionInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RouterV1alpha1().Interfaces(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RouterV1alpha1().Interfaces(namespace).Watch(context.TODO(), options)
			},
		},
		&routerv1alpha1.Interface{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *interfaceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&routerv1alpha1.Interface{}, f.defaultInformer)
}
