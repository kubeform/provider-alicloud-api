	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RosV1alpha1().Templates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RosV1alpha1().Templates(namespace).Watch(context.TODO(), options)
			},
		},
		&rosv1alpha1.Template{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *templateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rosv1alpha1.Template{}, f.defaultInformer)
}
