	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EssV1alpha1().Schedules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EssV1alpha1().Schedules(namespace).Watch(context.TODO(), options)
			},
		},
		&essv1alpha1.Schedule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *scheduleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&essv1alpha1.Schedule{}, f.defaultInformer)
}
