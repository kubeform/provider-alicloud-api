	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EssV1alpha1().Attachments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EssV1alpha1().Attachments(namespace).Watch(context.TODO(), options)
			},
		},
		&essv1alpha1.Attachment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *attachmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&essv1alpha1.Attachment{}, f.defaultInformer)
}
