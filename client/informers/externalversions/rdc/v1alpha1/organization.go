...
import (
	...
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/listers/rdc/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RdcV1alpha1().Organizations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RdcV1alpha1().Organizations(namespace).Watch(context.TODO(), options)
			},
		},
		&rdcv1alpha1.Organization{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *organizationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rdcv1alpha1.Organization{}, f.defaultInformer)
}
