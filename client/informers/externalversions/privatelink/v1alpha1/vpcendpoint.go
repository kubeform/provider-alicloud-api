	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PrivatelinkV1alpha1().VpcEndpoints(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PrivatelinkV1alpha1().VpcEndpoints(namespace).Watch(context.TODO(), options)
			},
		},
		&privatelinkv1alpha1.VpcEndpoint{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *vpcEndpointInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&privatelinkv1alpha1.VpcEndpoint{}, f.defaultInformer)
}
