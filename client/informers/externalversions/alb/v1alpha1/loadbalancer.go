	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AlbV1alpha1().LoadBalancers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AlbV1alpha1().LoadBalancers(namespace).Watch(context.TODO(), options)
			},
		},
		&albv1alpha1.LoadBalancer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *loadBalancerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&albv1alpha1.LoadBalancer{}, f.defaultInformer)
}
