	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AlbV1alpha1().Rules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AlbV1alpha1().Rules(namespace).Watch(context.TODO(), options)
			},
		},
		&albv1alpha1.Rule{},
		resyncPeriod,
...
func (f *ruleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&albv1alpha1.Rule{}, f.defaultInformer)
}
