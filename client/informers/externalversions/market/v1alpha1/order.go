...
import (
	...
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/listers/market/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MarketV1alpha1().Orders(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MarketV1alpha1().Orders(namespace).Watch(context.TODO(), options)
			},
		},
		&marketv1alpha1.Order{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *orderInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&marketv1alpha1.Order{}, f.defaultInformer)
}
