	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RouteV1alpha1().Tables(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RouteV1alpha1().Tables(namespace).Watch(context.TODO(), options)
			},
		},
		&routev1alpha1.Table{},
		resyncPeriod,
...
func (f *tableInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&routev1alpha1.Table{}, f.defaultInformer)
}
