	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PvtzV1alpha1().Zones(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PvtzV1alpha1().Zones(namespace).Watch(context.TODO(), options)
			},
		},
		&pvtzv1alpha1.Zone{},
		resyncPeriod,
...
func (f *zoneInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pvtzv1alpha1.Zone{}, f.defaultInformer)
}
