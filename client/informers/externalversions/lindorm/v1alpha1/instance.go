...
import (
	...
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/listers/lindorm/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LindormV1alpha1().Instances(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LindormV1alpha1().Instances(namespace).Watch(context.TODO(), options)
			},
		},
		&lindormv1alpha1.Instance{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *instanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&lindormv1alpha1.Instance{}, f.defaultInformer)
}
