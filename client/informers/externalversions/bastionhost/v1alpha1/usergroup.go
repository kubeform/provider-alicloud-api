	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BastionhostV1alpha1().UserGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BastionhostV1alpha1().UserGroups(namespace).Watch(context.TODO(), options)
			},
		},
		&bastionhostv1alpha1.UserGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *userGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&bastionhostv1alpha1.UserGroup{}, f.defaultInformer)
}
