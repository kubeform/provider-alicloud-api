	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BastionhostV1alpha1().HostGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BastionhostV1alpha1().HostGroups(namespace).Watch(context.TODO(), options)
			},
		},
		&bastionhostv1alpha1.HostGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *hostGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&bastionhostv1alpha1.HostGroup{}, f.defaultInformer)
}

func (f *hostGroupInformer) Lister() v1alpha1.HostGroupLister {
	return v1alpha1.NewHostGroupLister(f.Informer().GetIndexer())
}
