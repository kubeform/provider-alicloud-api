	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MhubV1alpha1().Apps(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MhubV1alpha1().Apps(namespace).Watch(context.TODO(), options)
			},
		},
		&mhubv1alpha1.App{},
		resyncPeriod,
...
func (f *appInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mhubv1alpha1.App{}, f.defaultInformer)
}
