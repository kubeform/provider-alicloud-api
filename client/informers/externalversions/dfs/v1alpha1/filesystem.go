	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DfsV1alpha1().FileSystems(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DfsV1alpha1().FileSystems(namespace).Watch(context.TODO(), options)
			},
		},
		&dfsv1alpha1.FileSystem{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fileSystemInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dfsv1alpha1.FileSystem{}, f.defaultInformer)
}
