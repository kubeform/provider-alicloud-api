	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VpcV1alpha1().TrafficMirrorSessions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VpcV1alpha1().TrafficMirrorSessions(namespace).Watch(context.TODO(), options)
			},
		},
		&vpcv1alpha1.TrafficMirrorSession{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *trafficMirrorSessionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vpcv1alpha1.TrafficMirrorSession{}, f.defaultInformer)
}
