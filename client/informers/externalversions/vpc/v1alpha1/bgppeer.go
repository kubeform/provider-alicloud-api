	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VpcV1alpha1().BgpPeers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VpcV1alpha1().BgpPeers(namespace).Watch(context.TODO(), options)
			},
		},
		&vpcv1alpha1.BgpPeer{},
		resyncPeriod,
...
func (f *bgpPeerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vpcv1alpha1.BgpPeer{}, f.defaultInformer)
}

func (f *bgpPeerInformer) Lister() v1alpha1.BgpPeerLister {
	return v1alpha1.NewBgpPeerLister(f.Informer().GetIndexer())
}
