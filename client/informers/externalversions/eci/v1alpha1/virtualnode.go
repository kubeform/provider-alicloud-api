	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EciV1alpha1().VirtualNodes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EciV1alpha1().VirtualNodes(namespace).Watch(context.TODO(), options)
			},
		},
		&eciv1alpha1.VirtualNode{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *virtualNodeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eciv1alpha1.VirtualNode{}, f.defaultInformer)
}
