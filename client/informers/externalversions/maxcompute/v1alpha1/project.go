...
import (
	...
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/listers/maxcompute/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MaxcomputeV1alpha1().Projects(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MaxcomputeV1alpha1().Projects(namespace).Watch(context.TODO(), options)
			},
		},
		&maxcomputev1alpha1.Project{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *projectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&maxcomputev1alpha1.Project{}, f.defaultInformer)
}
