	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EcdV1alpha1().Commands(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EcdV1alpha1().Commands(namespace).Watch(context.TODO(), options)
			},
		},
		&ecdv1alpha1.Command{},
		resyncPeriod,
...
func (f *commandInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ecdv1alpha1.Command{}, f.defaultInformer)
}
