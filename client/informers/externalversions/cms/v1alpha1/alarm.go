	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CmsV1alpha1().Alarms(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CmsV1alpha1().Alarms(namespace).Watch(context.TODO(), options)
			},
		},
		&cmsv1alpha1.Alarm{},
		resyncPeriod,
...
func (f *alarmInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cmsv1alpha1.Alarm{}, f.defaultInformer)
}
