	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LogV1alpha1().Alerts(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LogV1alpha1().Alerts(namespace).Watch(context.TODO(), options)
			},
		},
		&logv1alpha1.Alert{},
		resyncPeriod,
...
func (f *alertInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&logv1alpha1.Alert{}, f.defaultInformer)
}
