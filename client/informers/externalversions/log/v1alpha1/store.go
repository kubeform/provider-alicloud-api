	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LogV1alpha1().Stores(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LogV1alpha1().Stores(namespace).Watch(context.TODO(), options)
			},
		},
		&logv1alpha1.Store{},
		resyncPeriod,
...
func (f *storeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&logv1alpha1.Store{}, f.defaultInformer)
}
