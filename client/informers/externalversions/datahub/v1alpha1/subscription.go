...
import (
	...
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/listers/datahub/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DatahubV1alpha1().Subscriptions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DatahubV1alpha1().Subscriptions(namespace).Watch(context.TODO(), options)
			},
		},
		&datahubv1alpha1.Subscription{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *subscriptionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&datahubv1alpha1.Subscription{}, f.defaultInformer)
}
