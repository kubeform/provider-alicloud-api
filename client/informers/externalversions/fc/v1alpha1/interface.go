...
// FunctionAsyncInvokeConfigs returns a FunctionAsyncInvokeConfigInformer.
func (v *version) FunctionAsyncInvokeConfigs() FunctionAsyncInvokeConfigInformer {
	return &functionAsyncInvokeConfigInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
