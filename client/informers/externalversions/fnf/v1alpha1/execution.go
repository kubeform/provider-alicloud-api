...
import (
	...
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/listers/fnf/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FnfV1alpha1().Executions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FnfV1alpha1().Executions(namespace).Watch(context.TODO(), options)
			},
		},
		&fnfv1alpha1.Execution{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *executionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&fnfv1alpha1.Execution{}, f.defaultInformer)
}
