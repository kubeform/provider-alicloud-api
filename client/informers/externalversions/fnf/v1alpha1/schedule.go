	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FnfV1alpha1().Schedules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FnfV1alpha1().Schedules(namespace).Watch(context.TODO(), options)
			},
		},
		&fnfv1alpha1.Schedule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *scheduleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&fnfv1alpha1.Schedule{}, f.defaultInformer)
}
