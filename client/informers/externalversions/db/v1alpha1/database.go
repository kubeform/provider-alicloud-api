	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DbV1alpha1().Databases(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DbV1alpha1().Databases(namespace).Watch(context.TODO(), options)
			},
		},
		&dbv1alpha1.Database{},
		resyncPeriod,
...
func (f *databaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dbv1alpha1.Database{}, f.defaultInformer)
}
