...
type Interface interface {
	...
	// ElasticInstances returns a ElasticInstanceInformer.
	ElasticInstances() ElasticInstanceInformer
...
// ElasticInstances returns a ElasticInstanceInformer.
func (v *version) ElasticInstances() ElasticInstanceInformer {
	return &elasticInstanceInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
