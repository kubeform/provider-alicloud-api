	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EcsV1alpha1().NetworkInterfaces(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EcsV1alpha1().NetworkInterfaces(namespace).Watch(context.TODO(), options)
			},
		},
		&ecsv1alpha1.NetworkInterface{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkInterfaceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ecsv1alpha1.NetworkInterface{}, f.defaultInformer)
}
