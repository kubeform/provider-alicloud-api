...
import (
	...
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/listers/imm/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ImmV1alpha1().Projects(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ImmV1alpha1().Projects(namespace).Watch(context.TODO(), options)
			},
		},
		&immv1alpha1.Project{},
		resyncPeriod,
...
func (f *projectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&immv1alpha1.Project{}, f.defaultInformer)
}
