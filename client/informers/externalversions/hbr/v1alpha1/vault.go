	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.HbrV1alpha1().Vaults(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.HbrV1alpha1().Vaults(namespace).Watch(context.TODO(), options)
			},
		},
		&hbrv1alpha1.Vault{},
		resyncPeriod,
...
func (f *vaultInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&hbrv1alpha1.Vault{}, f.defaultInformer)
}
