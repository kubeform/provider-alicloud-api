...
import (
	...
	v1alpha1 "kubeform.dev/provider-alicloud-api/client/listers/eip/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EipV1alpha1().Addresses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EipV1alpha1().Addresses(namespace).Watch(context.TODO(), options)
			},
		},
		&eipv1alpha1.Address{},
		resyncPeriod,
...
func (f *addressInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eipv1alpha1.Address{}, f.defaultInformer)
}
