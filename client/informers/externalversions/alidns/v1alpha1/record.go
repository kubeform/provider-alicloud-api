	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AlidnsV1alpha1().Records(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AlidnsV1alpha1().Records(namespace).Watch(context.TODO(), options)
			},
		},
		&alidnsv1alpha1.Record{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *recordInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&alidnsv1alpha1.Record{}, f.defaultInformer)
}
